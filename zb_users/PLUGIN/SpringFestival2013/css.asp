...
BlodColor2(0)="#80100b"
NormalColor2(0)="#cc2723"
LightColor2(0)="#e8564e"
HighColor2(0)="#a51b13"
AntiColor2(0)="#15b9d7"
...
If id="random" Then
	Randomize
	id=Int((Ubound(BlodColor2) - LBound(BlodColor2) + 1) * Rnd + LBound(BlodColor2))
End If
...
c=Replace(c,c1,BlodColor2(id))
c=Replace(c,c2,NormalColor2(id))
c=Replace(c,c3,LightColor2(id))
c=Replace(c,c4,HighColor2(id))
c=Replace(c,c5,AntiColor2(id))
