                ...
                <tr style="display:none">
                  ...
                  <td><p>
                      <label onclick="changeval(2,1)">
                        ...
                        &nbsp;&nbsp;配置1:页面名型 <%=BlogHost%>页面名.html</label>
                    </p>
                    <p>
                  ...
                  <p>
                    ...
                    <p>
                      <label onclick="changeval(5,2)">
                        <input type="radio" name="radio5">
                        &nbsp;&nbsp;配置2: <%=BlogHost%><%=ZC_STATIC_DIRECTORY%>/<%=Year(Now)%>-<%=Month(Now)%>/</label>
                    </p>
                  <p>
                    ...
                    <p>
                      <label onclick="changeval(5,4)">
                        <input type="radio" name="radio5">
                        &nbsp;&nbsp;配置2: <%=BlogHost%><%=ZC_STATIC_DIRECTORY%>/<%=Year(Now)%>-<%=Month(Now)%>.html</label>
                    </p>
                    </td>
                </tr>
              </table>
        ...
        <script type="text/javascript">
			...
			$(":radio[name='POST_STATIC']").live("click",function(){
				...
				if($(this).val()=="REWRITE"){
					...
					$("#edtZC_DATE_REGEX").val("{%host%}/{%date%}/default.html");
				};
				flashradio();
			});
