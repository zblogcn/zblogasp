			...
			<div class="clear"></div>				
              ...
              <div class="content-box-content" id="qqcbox">
                ...
                <div class="tab-content default-tab" style='border:none;padding:0px;margin:0;' id="tab0">
                  ...
                  <p>QQ登录APP ID:</p>
                  <p><input name="AppId" type="text" id="ap" value="<%=ZBQQConnect_Config.Read("AppID")%>"/></p>
                  
                  <p>QQ登录KEY:</p>
                  <p><input name="KEY" type="text" id="as" value="<%=ZBQQConnect_Config.Read("KEY")%>"/></p>
                  ...
                  <div id="how" class="hidden">
                        ...
                        <p>4.填写你的网站名称、域名，保存。把得到的APP ID和KEY填写入插件即可使用QQ登录。另：域名需要认证。如图 </p><p><img src="a.jpg" alt="" width="486" height="365" /></p>
                ...
                <div class="tab-content" style='border:none;padding:0px;margin:0;' id="tab2">
                  ...
                  <p>
                   <font color="#009900">同步到微博内容（%a—评论作者；%c——评论摘要）</font>
				  </p>
                  <p>
                    <label for="pl"></label>
              ...
              <div class="tab-content" style='border:none;padding:0px;margin:0;' id="tab5">
                ...
                输入Gravatar地址（用&lt;#EmailMD5#&gt;来代替EMail的MD5,&lt;#ZC_BLOG_HOST#&gt;代替网站域名）
                  <input name="Gravatar" type="text" id="Gravatar" value="<%=TransferHTML(ZBQQConnect_Config.Read("Gravatar"),"[html-format]")%>"/>
                </p>
                <p>调用代码： </p>
...
&lt;img width=&quot;32&quot; height=&quot;32&quot; alt=&quot;头像&quot; title=&quot;头像&quot; src=&quot;&lt;#ZBQQConnect_Head#&gt;&quot; /&gt;
                ...
                <p>网站：<a href="http://www.zsxsoft.com" target="_blank">http://www.zsxsoft.com</a></p>
					</td></tr></table>
              </div>
