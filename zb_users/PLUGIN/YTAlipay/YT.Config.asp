...
<div id="divMain"><div id="ShowBlogHint">
  ...
  <div class="SubMenu"> <a href="YT.Panel.asp"><span class="m-left">订单管理</span></a><a href="YT.Config.asp"><span class="m-left m-now">系统配置</span></a>
  </div>
  <div id="divMain2">
...
<td width="88%"><input type="text" id="partner" name="partner" style="width:95%" value="<%=Config.sPartner%>" /></td>
</tr>
<tr>
  <td align="right">安全检验码</td>
  <td><input type="text" id="key" name="key" style="width:95%" value="<%=Config.sKey%>" /></td>
</tr>
<tr>
  <td align="right">支付宝帐户</td>
  <td><input type="text" id="seller_email" name="seller_email" style="width:95%" value="<%=Config.sSeller_Email%>" /></td>
</tr>
<tr>
  <td align="right">&nbsp;</td>
  <td>
