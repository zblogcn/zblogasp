...
<%
	...
	strSQL=strSQL&" WHERE  ([comm_isCheck]=-1 Or [comm_isCheck]=1) "
	...
	Response.Write "<form id=""frmBatch"" method=""post"" action=""""></form>"
	...
	Next
	Response.Write "<br/><form id=""frmBatch"" method=""post"" action=""""><p><input type=""hidden"" id=""edtBatch"" name=""edtBatch"" value=""""/><input class=""button button2"" type=""submit"" onclick='BatchDeleteAll(""edtBatch"");if(document.getElementById(""edtBatch"").value){this.form.action="""&ZC_BLOG_HOST&"/zb_users/plugin/totoro/commentdel.asp"&""";return window.confirm("""& ZC_MSG058 &""");}else{return false}' value=""删除所选择的评论"" id=""btnPost""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class=""button button2"" type=""submit"" onclick='BatchDeleteAll(""edtBatch"");if(document.getElementById(""edtBatch"").value){this.form.action="""&ZC_BLOG_HOST&"/zb_users/plugin/totoro/commentpass.asp"&""";return window.confirm("""& ZC_MSG058 &""");}else{return false}' value=""通过所选择的评论"" id=""btnPost""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class=""button button2"" type=""submit"" onclick='this.form.action="""&ZC_BLOG_HOST&"zb_users/plugin/totoro/commentdel.asp?act=delALL"&""";return window.confirm("""& ZC_MSG058 &""");' value=""删除数据库中所有未审核的评论"" id=""btnPost""/></p><form><br/>" & vbCrlf
