...
Sub ActivePlugin_YT_CMS()
	Call Add_Filter_Plugin("Filter_Plugin_TArticle_Export_Template","YT_CMS_Filter_Plugin_TArticle_Export_Template")
	Call Add_Filter_Plugin("Filter_Plugin_TArticleList_Build_Template","YT_CMS_Filter_Plugin_TArticleList_Build_Template")
	Call Add_Filter_Plugin("Filter_Plugin_TArticle_Export_Template_Sub","YT_CMS_Filter_Plugin_TArticle_Export_Template_Sub")
	...
	Call Add_Filter_Plugin("Filter_Plugin_PostArticle_Core","YT_CMS_Filter_Plugin_PostArticle_Core")
	Call Add_Filter_Plugin("Filter_Plugin_TArticle_Post","YT_CMS_Filter_Plugin_TArticle_Post")
	Call Add_Filter_Plugin("Filter_Plugin_TArticle_Build_Template","YT_CMS_Filter_Plugin_TArticle_Build_Template")
	Call Add_Filter_Plugin("Filter_Plugin_TArticle_LoadInfoByArray","YT_CMS_Filter_Plugin_TArticle_LoadInfoByArray")
	Call Add_Filter_Plugin("Filter_Plugin_TArticle_LoadInfobyID","YT_CMS_Filter_Plugin_TArticle_LoadInfobyID")	
	Call Add_Action_Plugin("Action_Plugin_ArticlePst_Succeed","YT_CMS_Action_Plugin_ArticlePst_Succeed")
