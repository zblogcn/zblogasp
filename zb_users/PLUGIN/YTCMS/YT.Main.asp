...
Sub ActivePlugin_YT_CMS()
	...
	Call Add_Action_Plugin("Action_Plugin_TArticle_Export_End","Call YT_CMS_Action_Plugin_TArticle_Export_End(html,subhtml,aryTemplateTagsName,aryTemplateTagsValue,subhtml_TemplateName)")
	Call Add_Action_Plugin("Action_Plugin_TArticleList_Export_Begin","Call YT_CMS_Action_Plugin_TArticleList_Export_Begin(intPage,anyCate,anyAuthor,dtmDate,anyTag)")
