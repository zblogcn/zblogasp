...
If CheckPluginState("ZBQQweibo")=False Then Call ShowError(48)
BlogTitle="腾讯微博调用"
Dim objConfig
Dim a
Set objConfig=New TConfig
objConfig.Load("ZBQQweibo")
...
If Request.QueryString("act")="save" Then
	...
	objConfig.Write "g",a
	objConfig.Save
	Call SaveToFile(BlogPath&"ZBQQweibo.asp",LoadFromFile(Server.MapPath("ZBQQweibo.asp"),"utf-8"),"utf-8",false)
