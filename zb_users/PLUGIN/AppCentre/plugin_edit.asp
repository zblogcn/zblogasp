...
<!--#include file="..\..\..\zb_system\admin\admin_top.asp"-->
        <div id="divMain">
          ...
          <div class="SubMenu">
            <%If ID="" Then Call AppCentre_SubMenu(4) Else Call AppCentre_SubMenu(-1):Response.Write "<a href=""plugin_pack.asp?id="&ID&""" target=""_blank""><span class=""m-right"">导出当前插件</span></a><a href=""submit.asp?type=plugin&id="&ID&"""><span class=""m-right"">上传</span></a>" End If%>
          </div>
          <div id="divMain2">
