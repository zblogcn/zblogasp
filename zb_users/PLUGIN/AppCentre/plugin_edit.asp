...
<div id="divMain">
  ...
  <div class="SubMenu">
    ...
    Else
      ...
      If login_pw <> "" Then Response.Write "<a href=""submit.asp?type=plugin&id="&ID&""" target=""_blank""><span class=""m-right"">上传到应用中心</span></a>"
      Response.Write "<a href=""plugin_pack.asp?id="&ID&""" target=""_blank""><span class=""m-right"">导出当前插件</span></a>"
    End If
    %>
  </div>
  <div id="divMain2">
    <form method="post" action="">
      <table border="1" width="100%" cellspacing="0" cellpadding="0" class="tableBorder tableBorder-thcenter">
        ...
        <tr>
          <td>
            <p> <b>· 插件ID</b>
              <br/>
              <span class="note">&nbsp;&nbsp;插件ID为插件的目录名,且不能重复.</span>
            </p>
          </td>
          <td>
            <p>
        ...
        <tr>
          ...
          <td>
            <p>
              &nbsp;
              <input id="app_note" name="app_note" style="width:550px;"  type="text" value="<%=TransferHTML(TransferHTML(app_note,"[textarea]"),"[""]")%>" /></p>
          </td>
        </tr>
        <tr>
          <td>
      ...
      <p>
        提示:插件的图标是名为 <u>logo.png</u>
        的
        <b>128x128px</b>
        大小的png文件,推荐使用
        <a href="http://www.syncfusion.com/downloads/metrostudio" target="_blank">Metro Studio</a>
        软件创建logo,插件的缩略图(可选)是名为 <u>screenshot.png</u>
        的
        <b>300x240px</b>
        大小的png文件,放在插件的目录下.
      </p>
