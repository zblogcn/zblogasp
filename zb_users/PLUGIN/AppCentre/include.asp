...
Function ActivePlugin_AppCentre()
	...
	Call Add_Response_Plugin("Response_Plugin_PluginMng_SubMenu",MakeSubMenu("在线安装插件<script src='"& BlogHost &"zb_users/plugin/appcentre/plugin.js' type='text/javascript'></script>",BlogHost & "zb_users/plugin/appcentre/plugin_list.asp?id=","m-left",False))
