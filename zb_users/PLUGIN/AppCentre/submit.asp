...
<div id="divMain"> <div id="ShowBlogHint">
  ...
  <div class="SubMenu"> 
	<%If ID="" Then Call AppCentre_SubMenu(1) Else Call AppCentre_SubMenu(-1):Response.Write "<a href=""" & Request.QueryString("type") & "_pack.asp?id="&ID&""" target=""_blank""><span class=""m-right"">导出当前插件</span></a>" End If%>
  </div>
  <div id="divMain2">
