...
<div id="divMain">
  ...
  <div class="SubMenu">
    <%If ID="" Then Call AppCentre_SubMenu(5) Else Call AppCentre_SubMenu(-1):Response.Write "<a href=""theme_pack.asp?id="&ID&""" target=""_blank""><span class=""m-right"">导出当前主题</span></a><a href=""submit.asp?type=theme&id="&ID&"""><span class=""m-right"">上传</span></a>" End If%>
  </div>
  <div id="divMain2">
