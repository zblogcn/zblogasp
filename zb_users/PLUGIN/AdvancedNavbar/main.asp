...
If CheckPluginState("AdvancedNavbar")=False Then Call ShowError(48)
BlogTitle="可视化导航栏（高级导航栏）"
...
<script type="text/javascript">ActiveLeftMenu("aAdvancedNavbar");</script> 
        <div id="divMain">
          <div id="ShowBlogHint">
            <%Call GetBlogHint()%>
          </div>
          <div class="divHeader"><%=BlogTitle%></div>
          <div class="SubMenu"><%=AdvancedNavbar_SubMenu(0)%></div>
          <div id="divMain2">
			...
			<div class="siderbar-list">
				...
				<div class="siderbar-header">当前主题自带链接</div>
		...
		<!--	
			<div class="siderbar-list">
				<div class="siderbar-drop" id="siderbar">
				<div class="siderbar-header">Z-Blog默认导航栏管理</div>
				<div  class="siderbar-sort-list ui-sortable">
				<div class="widget widget_source_other ">
				<div class="page-sidebar">
				  <ul id="connect"><%Response.Write FctContent%></ul>
			...
			<div class="siderbar-list">
				<div class="siderbar-drop" id="siderbar">
				<div class="siderbar-header">友情链接管理</div>
				<div  class="siderbar-sort-list ui-sortable">
				<div class="widget widget_source_other ">
				<div class="page-sidebar">
				  <ul id="connect"><%Response.Write FctContent%></ul>
			...
			<div class="siderbar-list">
				<div class="siderbar-drop" id="siderbar">
				<div class="siderbar-header">网站收藏管理</div>
				<div  class="siderbar-sort-list ui-sortable">
				<div class="widget widget_source_other ">
				<div class="page-sidebar">
				  <ul id="connect"><%Response.Write FctContent%></ul>
			...
			<div class="siderbar-list">
				<div class="siderbar-drop" id="siderbar">
				<div class="siderbar-header">图标汇集管理</div>
				<div  class="siderbar-sort-list ui-sortable">
				<div class="widget widget_source_other ">
				<div class="page-sidebar">
				  <ul id="connect"><%Response.Write FctContent%></ul>
