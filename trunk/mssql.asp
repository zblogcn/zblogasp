...
objConn.execute("CREATE TABLE [blog_Member] (mem_ID AutoIncrement primary key,mem_Level int default 0,mem_Name VARCHAR(20),mem_Password VARCHAR(32),mem_Sex int default 0,mem_Email VARCHAR(50),mem_MSN VARCHAR(50),mem_QQ VARCHAR(50),mem_HomePage VARCHAR(255),mem_LastVisit datetime,mem_Status int default 0,mem_PostLogs int default 0,mem_PostComms int default 0,mem_Intro text,mem_IP VARCHAR(15),mem_Count int default 0,mem_Guid VARCHAR(36),mem_Meta text)")
...
objConn.execute("CREATE TABLE [blog_Member] (mem_ID int identity(1,1) not null primary key,mem_Level int default 0,mem_Name nvarchar(20),mem_Password nvarchar(32),mem_Sex int default 0,mem_Email nvarchar(50),mem_MSN nvarchar(50),mem_QQ nvarchar(50),mem_HomePage nvarchar(255),mem_LastVisit datetime,mem_Status int default 0,mem_PostLogs int default 0,mem_PostComms int default 0,mem_Intro ntext,mem_IP nvarchar(15),mem_Count int default 0,mem_Guid  nvarchar(36),mem_Meta ntext)")
