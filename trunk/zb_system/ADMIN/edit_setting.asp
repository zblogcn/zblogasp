...
<%
	...
	Response.Write "<p style='display:none;'><input id=""edtZC_BLOG_HOST"" name=""edtZC_BLOG_HOST"" style=""width:90%;"" type=""text"" value=""" & strZC_BLOG_HOST & """ /></p>"
	Response.Write "<table width='100%' style='padding:0px;margin:0px;' cellspacing='0' cellpadding='0'>"
	'Response.Write "<tr><td width='30%'>" & SplitNameAndNote(ZC_MSG104) & "</td><td><p><input id=""edtZC_BLOG_HOST"" name=""edtZC_BLOG_HOST"" style=""width:90%;"" type=""text"" value=""" & strZC_BLOG_HOST & """ /></p></td></tr>"
	Response.Write "<tr><td width='30%'>" & SplitNameAndNote(ZC_MSG091) & "</td><td><p><input id=""edtZC_BLOG_NAME"" name=""edtZC_BLOG_NAME"" style=""width:90%;"" type=""text"" value=""" & strZC_BLOG_NAME & """ /></p></td></tr>"
	Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG092) & "</td><td><p><input id=""edtZC_BLOG_SUB_NAME"" name=""edtZC_BLOG_SUB_NAME"" style=""width:90%;""  type=""text"" value=""" & strZC_BLOG_SUB_NAME & """ /></p></td></tr>"
	Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG093) & "</td><td><p><input id=""edtZC_BLOG_TITLE"" name=""edtZC_BLOG_TITLE"" style=""width:90%;""  type=""text"" value=""" & strZC_BLOG_TITLE &""" /></p></td></tr>"
	Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG094) & "</td><td><p><input id=""edtZC_BLOG_SUBTITLE"" name=""edtZC_BLOG_SUBTITLE"" style=""width:90%;""  type=""text"" value=""" & strZC_BLOG_SUBTITLE & """ /></p></td></tr>"
	Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG096) & "</td><td><p><textarea cols=""3"" rows=""6"" id=""edtZC_BLOG_COPYRIGHT"" name=""edtZC_BLOG_COPYRIGHT"" style=""width:90%;"">" & strZC_BLOG_COPYRIGHT & "</textarea></p></td></tr>"
	...
	tmpSng=LoadFromFile(BlogPath & "zb_users/c_option.asp","utf-8")
		...
		Response.Write "<tr><td width='30%'>" & SplitNameAndNote(ZC_MSG174) & "</td><td><p><input id=""edtZC_BLOG_CLSID"" name=""edtZC_BLOG_CLSID"" style=""width:90%;"" type=""text"" value=""" & ZC_BLOG_CLSID & """ /></p></td></tr>"


		ZC_TIME_ZONE=TransferHTML(ZC_TIME_ZONE,"[html-format]")
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG175) & "</td><td><p><input id=""edtZC_TIME_ZONE"" name=""edtZC_TIME_ZONE"" style=""width:90%;"" type=""text"" value=""" & ZC_TIME_ZONE & """ /></p></td></tr>"




		ZC_HOST_TIME_ZONE=TransferHTML(ZC_HOST_TIME_ZONE,"[html-format]")
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG206) & "</td><td><p><input id=""edtZC_HOST_TIME_ZONE"" name=""edtZC_HOST_TIME_ZONE"" style=""width:90%;"" type=""text"" value=""" & ZC_HOST_TIME_ZONE & """ /></p></td></tr>"


		ZC_BLOG_LANGUAGE=TransferHTML(ZC_BLOG_LANGUAGE,"[html-format]")
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG176) & "</td><td><p><input id=""edtZC_BLOG_LANGUAGE"" name=""edtZC_BLOG_LANGUAGE"" style=""width:90%;"" type=""text"" value=""" & ZC_BLOG_LANGUAGE & """ /></p></td></tr>"



		ZC_UPLOAD_FILETYPE=TransferHTML(ZC_UPLOAD_FILETYPE,"[html-format]")
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG183) & "</td><td><p><input id=""edtZC_UPLOAD_FILETYPE"" name=""edtZC_UPLOAD_FILETYPE"" style=""width:90%;"" type=""text"" value=""" & ZC_UPLOAD_FILETYPE & """ /></p></td></tr>"


		ZC_UPLOAD_FILESIZE=TransferHTML(ZC_UPLOAD_FILESIZE,"[html-format]")
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG184) & "</td><td><p><input id=""edtZC_UPLOAD_FILESIZE"" name=""edtZC_UPLOAD_FILESIZE"" style=""width:90%;"" type=""text"" value=""" & ZC_UPLOAD_FILESIZE & """ /></p></td></tr>"
	...
	Response.Write "<table width='100%' style='padding:0px;margin:0px;' cellspacing='0' cellpadding='0'>"
		...
		Response.Write "<tr><td width='30%'>" & SplitNameAndNote(ZC_MSG190) & "</td><td><p><input id=""edtZC_DISPLAY_COUNT"" name=""edtZC_DISPLAY_COUNT"" style=""width:90%;"" type=""text"" value=""" & ZC_DISPLAY_COUNT & """ /></p></td></tr>"


		ZC_SEARCH_COUNT=TransferHTML(ZC_SEARCH_COUNT,"[html-format]")
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG274) & "</td><td><p><input id=""edtZC_SEARCH_COUNT"" name=""edtZC_SEARCH_COUNT"" style=""width:90%;"" type=""text"" value=""" & ZC_SEARCH_COUNT & """ /></p></td></tr>"
		...
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG230) & "</td><td><p><input id=""edtZC_MUTUALITY_COUNT"" name=""edtZC_MUTUALITY_COUNT"" style=""width:90%;"" type=""text"" value=""" & ZC_MUTUALITY_COUNT & """ /></p></td></tr>"
		...
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG171) & "</td><td><p><input id=""edtZC_COMMENTS_DISPLAY_COUNT"" name=""edtZC_COMMENTS_DISPLAY_COUNT"" style=""width:90%;"" type=""text"" value=""" & ZC_COMMENTS_DISPLAY_COUNT & """/></p></td></tr>"
	...
	Response.Write "<table width='100%' style='padding:0px;margin:0px;' cellspacing='0' cellpadding='0'>"
		...
		Response.Write "<tr><td width='30%'>" & SplitNameAndNote(ZC_MSG178) & "</td><td><p><input id=""edtZC_STATIC_DIRECTORY"" name=""edtZC_STATIC_DIRECTORY"" style=""width:90%;"" type=""text"" value=""" & ZC_STATIC_DIRECTORY & """ /></p></td></tr>"


		ZC_REBUILD_FILE_COUNT=TransferHTML(ZC_REBUILD_FILE_COUNT,"[html-format]")
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG181) & "</td><td><p><input id=""edtZC_REBUILD_FILE_COUNT"" name=""edtZC_REBUILD_FILE_COUNT"" style=""width:90%;"" type=""text"" value=""" & ZC_REBUILD_FILE_COUNT & """ /></p></td></tr>"



		ZC_REBUILD_FILE_INTERVAL=TransferHTML(ZC_REBUILD_FILE_INTERVAL,"[html-format]")
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG182) & "</td><td><p><input id=""edtZC_REBUILD_FILE_INTERVAL"" name=""edtZC_REBUILD_FILE_INTERVAL"" style=""width:90%;"" type=""text"" value=""" & ZC_REBUILD_FILE_INTERVAL & """ /></p></td></tr>"
	...
	Response.Write "<table width='100%' style='padding:0px;margin:0px;' cellspacing='0' cellpadding='0'>"
		...
		Response.Write "<tr><td width='30%'>" & SplitNameAndNote(ZC_MSG217) & "</td><td><p><input id=""edtZC_DISPLAY_COUNT_WAP"" name=""edtZC_DISPLAY_COUNT_WAP"" style=""width:90%;"" type=""text"" value=""" & ZC_DISPLAY_COUNT_WAP & """ /></p></td></tr>"
		...
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG218) & "</td><td><p><input id=""edtZC_COMMENT_COUNT_WAP"" name=""edtZC_COMMENT_COUNT_WAP"" style=""width:90%;"" type=""text"" value=""" & ZC_COMMENT_COUNT_WAP & """ /></p></td></tr>"
		...
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG219) & "</td><td><p><input id=""edtZC_PAGEBAR_COUNT_WAP"" name=""edtZC_PAGEBAR_COUNT_WAP"" style=""width:90%;"" type=""text"" value=""" & ZC_PAGEBAR_COUNT_WAP & """ /></p></td></tr>"
		...
		Response.Write "<tr><td>" & SplitNameAndNote(ZC_MSG102) & "</td><td><p><input id=""edtZC_WAP_MUTUALITY_LIMIT"" name=""edtZC_WAP_MUTUALITY_LIMIT"" style=""width:90%;"" type=""text"" value=""" & ZC_WAP_MUTUALITY_LIMIT & """ /></p></td></tr>"
