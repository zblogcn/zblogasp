...
<div id="divContent" style="clear:both;">
	...
	<textarea style="margin-top:5px;" rows="4" class="resizable" onChange="GetActiveText(this.id);" onClick="GetActiveText(this.id);" onFocus="GetActiveText(this.id);" name="txaContent" id="txaContent"><%=EditArticle.Content%></textarea></p>
</div>
