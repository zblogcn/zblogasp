...
BlogHost & "zb_users/plugin/uecomment/uecomment.pack.js\""></script>"");") 
...
'注册插件
Call RegisterPlugin("UEComment","ActivePlugin_UEComment")
'挂口部分
Function ActivePlugin_UEComment()
	Call Add_Filter_Plugin("Filter_Plugin_TComment_MakeTemplate_TemplateTags","UEComment_ExportCommentHTML")
	Call Add_Action_Plugin("Action_Plugin_BlogReBuild_Comments_Begin","BlogReBuild_Comments=UEComment_ReBuild():Exit Function")
End Function

Function UEComment_ExportCommentHTML(t,v)
	Dim s
	s=v(7)
	...
	s=AntiXSS_run(s)
	s=Replace(Replace(s,"&lt;!--","<!--"),"--&gt;","-->")
	s=UEComment_AntiOther(s)
	v(7)=s	
	
	
End Function

Function UEComment_AntiOther(s)
	Dim b
	Set b=New RegExp
	b.IgnoreCase=True
	...
	Next
	UEComment_AntiOther=s1
End Function

Function UEComment_ReBuild()
