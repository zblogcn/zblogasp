...
On Error Resume Next
	...
	If Install_Error<>0 Then
		Response.Write "<p class=""status-box""><font color=""red""> × 主题上传失败. "
...
On Error Resume Next
	...
	Else
		...
		Response.Write "请 <a href=""Xml_upload.asp?confirm=yes&amp;act=cancel"" title=""重新上传""><span>[取消安装并返回]</span></a></font></p>"
	End If
