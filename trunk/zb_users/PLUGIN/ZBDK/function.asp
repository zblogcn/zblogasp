...
ZBDK.submenu=function(j){
	var aryname=new Array("首页","BlogConfig","LoadCounter","RunSQL","PluginInterface");
	var aryurl=new Array("main.asp","BlogConfig/main.asp","LoadCounter/main.asp","RunSQL/main.asp","PluginInterface/main.asp");
	var arycss=new Array("m-left","m-left","m-left","m-left","m-left");
	for(var i=0;i<=aryname.length;i++){
		Response.Write(MakeSubMenu(aryname[i],BlogHost+"zb_users/plugin/zbdk/"+aryurl[i],(j==i?arycss[i]+" m-now":arycss[i]),false));
	}
}
</script>