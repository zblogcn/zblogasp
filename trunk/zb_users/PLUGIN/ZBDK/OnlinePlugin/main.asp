...
<!--#include file="..\..\..\..\zb_system\admin\admin_top.asp"-->
        ...
        <div id="divMain">
          ...
          <div class="SubMenu"> <%=ZBDK.submenu("OnlinePlugin")%> </div>
          <div id="divMain2"> 
            <script type="text/javascript">ActiveTopMenu("zbdk");</script>
            <form id="form1" name="form1" method="post" action="main.asp?act=save">
              <input type="submit" value="保存"/><label for="asp">在这里直接输入ASP代码，只要启用ZBDK插件这段代码就能有效。Action和Filter接口请写于ZBDK_OnlinePlugin_ActivePlugin过程。不能有语法错误。</label>
