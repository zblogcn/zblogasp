...
Function ActivePlugin_AppCentre()
	...
	Call Add_Response_Plugin("Response_Plugin_ThemeMng_SubMenu",MakeSubMenu("新建主题<script src='"& BlogHost &"zb_users/plugin/appcentre/theme.js' type='text/javascript'></script>",BlogHost & "zb_users/plugin/appcentre/theme_edit.asp?id=","m-left",False))

	Call Add_Response_Plugin("Response_Plugin_PluginMng_SubMenu",MakeSubMenu("新建插件<script src='"& BlogHost &"zb_users/plugin/appcentre/plugin.js' type='text/javascript'></script>",BlogHost & "zb_users/plugin/appcentre/theme_edit.asp?id=","m-left",False))
