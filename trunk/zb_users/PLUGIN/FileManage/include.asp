...
Function ActivePlugin_FileManage()
    Call Add_Response_Plugin("Response_Plugin_AdminLeft_Plugin",MakeLeftMenu(ZC_MSG210,ZC_BLOG_HOST&"/zb_users/plugin/filemanage/main.asp","nav_file","aSiteFileMng",""))
