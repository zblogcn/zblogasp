...
function renderxh(){
	xheditor=$('#txaArticle').xheditor({tools:'Bold,Italic,Underline,FontColor,Link,Unlink,Emot,|,About',width:'150',clickCancelDialog:false,forcePtag:false,submitID:'btnSumbit',internalStyle:false,inlineStyle:false,html5Upload:false,emotPath:bloghost+"zb_users/emotion/",skin:'nostyle',emotMark:true,beforeSetSource:ubb2html,beforeGetSource:html2ubb});
}
