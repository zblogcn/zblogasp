                ...
                <div class="content-box-content" id="qqcbox">
                  ...
                  <div class="tab-content" style='border:none;padding:0px;margin:0;' id="tab2">
                    <table class="tableBorder"  style='padding:0px;margin:0px;' cellspacing='0' cellpadding='0' width="100%">
                      ...
                      <tr>
                        ...
                        无论有无勾选，若用户没有绑定QQ，则使用管理员的身份同步。微博暂只能使用管理员的身份同步
                        </div>
                  ...
                  <div class="tab-content" style='border:none;padding:0px;margin:0;' id="tab3">
                    <table class="tableBorder"  style='padding:0px;margin:0px;' cellspacing='0' cellpadding='0' width="100%">
                      ...
                      <tr><td><font color="#0000CC">允许使用QQ登录</font></td><td><input name="h" id="h" type="text" class="checkbox" <%=d(qqconnect.tconfig.read("h"))%> /></td></tr>
                      <tr><td>
                                              <div id="help003" style="display:none">
                       必须打开注册组件
                        </div><font color="#0000CC">允许使用QQ注册帐号</font><a id="help03" href="$help003?width=320" class="betterTip" title="帮助">？</a></td><td>
                            <input name="i" id="i" type="text" class="checkbox" <%=d(qqconnect.tconfig.read("i"))%> /></td></tr>
                    </table>
                  </div>
