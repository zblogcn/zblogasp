/* KindEditor 4.1.4 (2012-11-11), Copyright (C) kindsoft.net, Licence: http://www.kindsoft.net/license.php */
(function(z, m) {
	function W(a) {
		if (!a) return ! 1;
	...
	function gb(a) {
		try {
			...
			a.removeAttribute && a.removeAttribute(X)
		}
	}
	function Y(a, b, c) {
	...
	function ea(a, b, c) {
		...
		function() {
			...
			function(b, c) {
				...
				var e = v[d][b];
				if (e && e.length > 0) {
					c === m ? (va(a, b, e[0]), delete v[d][b]) : (k(e,
					function(a, b) {
	...
	function R(a, b, c, d, e) {
		...
		function(a, l, p, t, wa, E, G) {
			...
			if (lb[m] && !Ia[m]) if (d) {
				...
				G = l = "\n";
				wa = 0;
				for (E = p ? f.length: f.length - 1; wa < E; wa++) l += e,
				p || (G += e);
				t ? f.pop() : p || (G += e)
			} else l = G = "";
			if (n !== "") {
				...
				function(a, d) {
					Tb[a] && (w[a] = a);
					M(a, ["src", "href"]) >= 0 && (w[a] = ga(d, c)); (b && a !== "style" && !h[m]["*"] && !h[m][a] || m === "body" && a === "contenteditable" || /^kindeditor_\d+$/.test(a)) && delete w[a];
					if (a === "style" && d !== "") {
						var e = fa(d);
						k(e,
						function(a) {
	...
	function Aa(a, b) {
		...
		function e(a, b, c) {
			var e = []; (a = (c.ownerDocument || c).getElementById(a.replace(/\\/g, ""))) && d(b, a.nodeName) && ya(c, a) && e.push(a);
			return e
		}
		function g(a, b, c) {
		...
		function h(a, b, d, e) {
			...
			e.nodeType == 1 && (b === null ? za(e, a) !== null && g.push(e) : b === c(za(e, a)) && g.push(e));
			return g
		}
		function f(a, b) {
			var c = [],
			...
			if (i = /#((?:[\w\-]|\\.)+)$/.exec(a)) c = e(i[1], j, b);
			...
			else if (i = /\[((?:[\w\-]|\\.)+)\]/.exec(a)) c = h(i[1].toLowerCase(), null, j, b);
				...
				if (c === "id") j = e(i, j, b);
					...
					for (var l, p = 0,
					t = i.length; p < t; p++) l = i[p],
					d(j, l.nodeName) && ya(b, l) && l.getAttributeNode("name") && c.push(l);
					j = c
				} else j = h(c, i, j, b);
				c = j
			} else {
		...
		j = [], p, t = /((?:\\.|[^\s>])+|[\s>])/g; p = t.exec(a);) p[1] !== " " && j.push(p[1]);
		p = [];
		if (j.length == 1) return f(j[0], b);
		var t = !1,
		m, E, n, o, q, w, xa, H, r, s;
		w = 0;
		for (lenth = j.length; w < lenth; w++) if (m = j[w], m === ">") t = !0;
			...
			if (w > 0) {
				...
				for (r = p.length; xa < r; xa++) {
					...
					n = f(m, o);
					H = 0;
					for (s = n.length; H < s; H++) q = n[H],
					t ? o === q.parentNode && E.push(q) : E.push(q)
				}
				p = E
			} else p = f(m, b);
	...
	function Ka(a, b, c) {
		o && C < 8 && b.toLowerCase() == "class" && (b = "className");
		a.setAttribute(b, "" + c)
	}
	function La(a) {
	...
	function Na(a, b, c) {
		...
		function g(e, k) {
			...
			o; n;) {
				...
				if (m >= 0) return ! 1;
				o = n.nextSibling;
				if (l > 0) if (n.nodeType == 1) if (p >= 0 && t <= 0) b && k.appendChild(n.cloneNode(!0)),
				c && f.push(n);
				else {
					var E;
					b && (E = n.cloneNode(!1), k.appendChild(E));
					if (g(n, E) === !1) return ! 1
				} else if (n.nodeType == 3 && (n = n == j.startContainer ? d(n, j.startOffset, n.nodeValue.length) : n == j.endContainer ? d(n, 0, j.endOffset) : d(n, 0, n.nodeValue.length), b)) try {
					k.appendChild(n)
				} catch(G) {}
				n = o
			}
		...
		if (k.nodeType == 3) return k = d(k, a.startOffset, a.endOffset),
		b && n.appendChild(k),
		e(),
		b ? n: a;
		g(k, n);
	...
	function rb(a, b) {
		...
		i -= l.text.replace(/\r\n|\n|\r/g, "").length;
		if (j > 0 && h.nodeType == 3) for (c = h.previousSibling; c && c.nodeType == 3;) i -= c.nodeValue.length,
		c = c.previousSibling;
		return {
			node: h,
			offset: i
	...
	function yb(a) {
		a.nodeName && (a = S(a), a = Oa(a).selectNodeContents(a.body).collapse(!1));
		return new la(a)
	}
	function Ta(a) {
		var b = a.moveEl,
		...
		d = a.clickEl || b,
		e = a.beforeDrag,
		g = [document]; (a.iframeFix === m || a.iframeFix) && f("iframe").each(function() {
	...
	function $a(a) {
		for (var b = document.getElementsByTagName("head")[0] || (N ? document.body: document.documentElement), c = document.createElement("link"), d = Eb(ga(a, "absolute")), e = f('link[rel="stylesheet"]', b), g = 0, h = e.length; g < h; g++) if (Eb(ga(e[g].href, "absolute")) === d) return;
		b.appendChild(c);
		c.href = a;
		c.rel = "stylesheet"
	}
		...
		if (! (o && d !== "br") && (!ca || !(C < 3 && d !== "p")) && !(Ma && C < 9)) {
			...
			f(c).keydown(function(f) {
				if (! (f.which != 13 || f.shiftKey || f.ctrlKey || f.altKey)) {
					b.cmd.selection();
					var i = a(b.cmd.range);
					i == "marquee" || i == "select" || (d === "br" && !e[i] ? (f.preventDefault(), b.insertHtml("<br />" + (o && C < 9 ? "": "\u200b"))) : g[i] || O(c, "formatblock", "<p>"))
				}
			});
			f(c).keyup(function(e) {
				if (! (e.which != 13 || e.shiftKey || e.ctrlKey || e.altKey) && d != "br") if (ca) {
					var e = b.cmd.commonAncestor("p"),
					i = b.cmd.commonAncestor("a");
					i.text() == "" && (i.remove(!0), b.cmd.range.selectNodeContents(e[0]).collapse(!0), b.cmd.select())
	...
	function Jb(a, b) {
		...
		c.designMode ? (c.html(h.html), h.start && (e.moveToBookmark(h), this.select())) : f(d).html(V(h.html));
		return this
	}
	function ra(a) {
		function b(a, b) {
	...
	function Kb(a, b) {
		...
		if ((d = f(a)) && d.length !== 0) {
			...
			Za(e.langPath + e.langType + ".js?ver=" + encodeURIComponent(f.DEBUG ? Da: Ea),
			function() {
				c(e)
			});
			return e
	...
	if (!z.KindEditor) {
		...
		C = (q = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(q)) ? q[1] : "0",
		Da = (new Date).getTime(),
		P = Math.round,
		f = {
			DEBUG: !1,
		...
		Fa = u("html,head,body,td,tr,table,ol,ul,li");
		...
		F(D, {
			init: function(a) {
				for (var a = W(a) ? a: [a], b = 0, c = 0, d = a.length; c < d; c++) a[c] && (this[c] = a[c].constructor === D ? a[c][0] : a[c], b++);
				this.length = b;
				this.doc = S(this[0]);
				this.name = La(this[0]);
			...
			attr: function(a, b) {
				...
				c;
				if (b === m) return b = c.length < 1 ? null: za(c[0], a),
				b === null ? "": b;
				c.each(function() {
					Ka(this, a, b)
				});
			...
			scan: function(a, b) {
				...
				if (! (this.length < 1)) return b = b === m ? !0 : b,
				c(this[0]),
				this
			}
		});
		...
		F(K, {
			...
			compareBoundaryPoints: function(a, b) {
				...
				if (o) {
					...
					if (c !== 0) return c;
					var g, h, i, j;
					if (a === ia || a === ja) g = this.startContainer,
					i = this.startOffset;
					if (a === ha || a === $) g = this.endContainer,
					i = this.endOffset;
					if (a === ia || a === ha) h = b.startContainer,
					j = b.startOffset;
					if (a === $ || a === ja) h = b.endContainer,
					j = b.endOffset;
					if (g === h) return g = i - j,
					g > 0 ? 1 : g < 0 ? -1 : 0;
			...
			cloneRange: function() {
				return (new K(this.doc)).setStart(this.startContainer, this.startOffset).setEnd(this.endContainer, this.endOffset)
			},
			toString: function() {
				var a = this.get();
		...
		F(la, {
				...
				f(a).scan(function(a) {
					if (!g && a == e.start) g = !0;
						...
						if (!d && b.type == 3 && A(a.nodeValue).length > 0) {
							...
							l = c;
							l = l.clone(!0);
							if (b.type == 3) Sa(l).append(b.clone(!1)),
							b.replaceWith(l);
							else {
								for (var a = b,
								p; (p = b.first()) && p.children().length == 1;) b = p;
								p = b.first();
								...
								for (var k = p,
								n = !1; l;) {
									for (; k;) k.name === l.name && (Xb(k, l.attr(), l.css()), n = !0),
									k = k.first();
			...
			split: function(a, b) {
				...
				d = c.doc,
				e = c.cloneRange().collapse(a), g = e.startContainer, h = e.startOffset, i = g.nodeType == 3 ? g.parentNode: g, j = !1, l; i && i.parentNode;) {
					l = f(i);
					if (b) {
						if (!l.isStyle()) break;
						if (!Qa(l, b)) break
				...
				h = g.firstChild,
				j = g.lastChild,
				a ? (e.insertNode(g), c.setStartAfter(j).setEndBefore(d)) : (i.appendChild(g), c.setStartBefore(d).setEndBefore(h)),
				e = d.parentNode,
			...
			remove: function(a) {
				...
				if (c.startOffset === 0) {
					...
					d.isBlock() && Ra(d, a); (d = d.parent()) && d.isBlock() && Ra(d, a)
				}
				if (c.collapsed) {
					this.split(!0, a);
					b = c.startContainer;
			...
			val: function(a) {
				...
				a = a.toLowerCase(),
				c = "";
				if (a === "fontfamily" || a === "fontname") return c = ub(b, "fontname"),
				c = c.replace(/['"]/g, ""),
				c.toLowerCase();
				if (a === "formatblock") {
					c = ub(b, a);
			...
			createlink: function(a, b) {
				...
				e = '<a href="' + B(a) + '" data-ke-src="' + B(a) + '" ';
				b && (e += ' target="' + B(b) + '"');
				if (d.collapsed) return e += ">" + B(a) + "</a>",
				this.inserthtml(e);
				if (d.isControl()) {
		...
		F(Q, {
			...
			autoPos: function(a, b) {
				...
				x = P(e.x + (h.clientWidth - c) / 2),
				y = P(e.y + (h.clientHeight - d) / 2);
				o && C < 7 || N || (x -= e.x, y -= e.y);
				return this.pos(x, y)
			},
			remove: function() {
				var a = this; (o && C < 7 || N) && f(a.win).unbind("scroll");
				a.div.remove();
				k(a,
				function(b) {
					a[b] = null
		...
		F(na, Q, {
			...
			html: function(a, b) {
				...
				if (this.designMode) {
					c = c.body;
					if (a === m) return a = b ? "<!doctype html><html>" + c.parentNode.innerHTML + "</html>": c.innerHTML,
			...
			afterChange: function(a) {
				...
				var c = this.doc,
				d = c.body;
				f(c).keyup(function(b) { ! b.ctrlKey && !b.altKey && bb[b.which] && a(b)
				});
		...
		F(Ba, Q, {
			...
			disableAll: function(a, b) {
				...
				b && (d = u(b)); (a === m ? !c.disableMode: a) ? (f("span.ke-outline", c.div).each(function() {
					var a = f(this),
		...
		F(Ya, {
			init: function(a) {
				...
				var j = [],
				l;
				for (l in g) j.push('<input type="hidden" name="' + l + '" value="' + g[l] + '" />');
		...
		F(qa, Q, {
			init: function(a) {
				...
				o && C < 7 ? this.iframeMask = f('<iframe src="about:blank" class="ke-dialog-shadow"></iframe>').appendTo(this.div) : b && f('<div class="ke-dialog-shadow"></div>').appendTo(this.div);
				...
				l.append(a);
				a.append(d);
				var m = f('<div class="ke-dialog-footer"></div>'); (e || g || h) && l.append(m);
				k([{
					btn: e,
					name: "preview"
				},
		...
		f.ajax = function(a, b, c, d, e) {
			var c = c || "GET",
			e = e || "json",
			f = z.XMLHttpRequest ? new z.XMLHttpRequest: new ActiveXObject("Microsoft.XMLHTTP");
			f.open(c, a, !0);
		...
		ra.prototype = {
			...
			loadPlugin: function(a, b) {
				...
				c.isLoading = !0;
				Za(c.pluginsPath + a + "/" + a + ".js?ver=" + encodeURIComponent(f.DEBUG ? Da: Ea),
				function() {
					c.isLoading = !1;
			...
			handler: function(a, b) {
				...
				if (cb(b)) return c._handlers[a].push(b),
				c;
				k(c._handlers[a],
				function() {
					b = this.call(c, b)
			...
			create: function() {
				...
				q = c.edit = zb({
					...
					afterCreate: function() {
						...
						q.textarea.keyup(function(a) { ! a.ctrlKey && !a.altKey && Ob[a.which] && c.options.afterChange && c.options.afterChange.call(c)
						});
				...
				}), i.select("fullscreen"), l.first().css("visibility", "hidden"), l.last().css("visibility", "hidden")) : (ca && f(z).bind("scroll",
				function() {
					c._scrollPos = Z()
				}), c.resizeType > 0 ? Ta({
					moveEl: h,
			...
			text: function(a) {
				return a === m ? A(this.html().replace(/<(?!img|embed).*?>/ig, "").replace(/&nbsp;/ig, " ")) : this.html(B(a))
			},
			isEmpty: function() {
		...
		o && C < 7 && O(document, "BackgroundImageCache", !0);
		f.EditorClass = ra;
		f.editor = function(a) {
			return new ra(a)
		};
		...
		function(a) {
			...
			function() {
				var a = '<div style="margin:20px;"><div>此插件由<a href="http://imzhou.com" target="_blank">未寒</a>制作，使用KindEditor 4.1.4替换了Z-Blog默认的UEditor编辑器。</div><div>Copyright &copy; <a href="http://www.kindsoft.net/" target="_blank">kindsoft.net</a> All rights reserved.</div></div>';
				b.createDialog({
					name: "about",
					width: 300,
					title: b.lang("about"),
			...
			b.beforeSetHtml(function(a) {
				...
				function(a, b, c, d, e) {
					...
					return a = b + c + '="' + d + '" data-ke-src="' + B(d) + '"' + e
				}).replace(/(<[^>]+\s)(on\w+="[^"]*"[^>]*>)/ig,
				function(a, b, c) {
					return b + "data-ke-" + c
