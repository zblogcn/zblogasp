...
Const ZC_MSG275=""
Const ZC_MSG276=""
Const ZC_MSG277="所属文章ID:(一般情况下请勿改动此数字)"
...
Const ZC_MSG288="侧栏的标签分别为&lt;#template:sidebar#&gt;,&lt;#template:sidebar2#&gt;,&lt;#template:sidebar3#&gt;,&lt;#template:sidebar4#&gt;,&lt;#template:sidebar5#&gt;,在主题模板中可以调用这些标签.默认只使用一个侧栏."
Const ZC_MSG289="更新"
...
Const ZC_MSG297="在正文插入'摘要分隔线'可以让系统生成摘要内容.如果需指定摘要内容,请点击 "
