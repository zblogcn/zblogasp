...
Function ActivePlugin_metro()
	...
	If c.Exists("vesion")=False Then
		c.Write "vesion","1.1"
		c.Write "custom_bodybg","#eee|images/bg.jpg|repeat|2|top|"
...
Function metro_savetofile(stylefile)
	...
	Set cc = New TConfig
	cc.Load("metro")
	If cc.Exists("vesion")=true Then
		strBodyBg=cc.read("custom_bodybg")
		strHdBg=cc.read("custom_hdbg")
		strColor=cc.read("custom_color")
