...
<div id="divMain">
	...
	<!--<div class="divHeader"><%=BlogTitle%></div>-->
  	<div class="SubMenu"><a href="main.asp"><span class="m-left m-now"><%=BlogTitle%></span></a><a href="navbar.asp"><span class="m-left">导航管理</span></a><a href="about.asp"><span class="m-left">主题说明</span></a></div>
	<div id="divMain2">
