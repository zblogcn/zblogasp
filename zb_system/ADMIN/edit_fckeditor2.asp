...
If Request.QueryString("typ")="tags" Then
...
<p><%=ZC_MSG055%>:(<span id="timemsg"></span><span id="msg2"></span><span id="msg"></span><SCRIPT LANGUAGE="JavaScript" src="c_autosaverjs.asp?act=edit&type=fckeditor"></SCRIPT>)<br/>
	<textarea class="ckeditor" style="display:none" rows="4" onChange="GetActiveText(this.id);" onClick="GetActiveText(this.id);" onFocus="GetActiveText(this.id);" name="txaContent" id="txaContent"><%=EditArticle.Content%></textarea>
	</p>
</div>
...
<!-- <div id="divIntro"> -->
	...
	<textarea class="ckeditor" style="display:none" rows="3" onChange="GetActiveText(this.id);" onClick="GetActiveText(this.id);" onFocus="GetActiveText(this.id);" name="txaIntro" id="txaIntro"><%=EditArticle.Intro%></textarea>
	</p>
</div>
<%
