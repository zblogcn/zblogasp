    ...
    me.commands['snapscreen'] = {
        execCommand: function(){
           ...
           var editorOptions = me.options;
            ...
            try{
                var ret =snapplugin.saveSnapshot(editorOptions.snapscreenHost,editorOptions.snapscreenServerUrl.replace(new RegExp("https?://"+editorOptions.snapscreenHost,"ig"),""), editorOptions.snapscreenServerPort.toString());
                onSuccess(ret);
            }catch(e){
