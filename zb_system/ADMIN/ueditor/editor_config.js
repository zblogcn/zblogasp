...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"asp/fileUp.asp"             //图片上传提交地址
        ...
        //word转存配置区
        ,wordImageUrl:URL + "asp/fileUp.asp"             //word转存提交地址
        ...
        ,webAppKey:"lcrxqTChgQEUQlVdLInuactP"
        ...
        ,initialContent:'<P></p>'    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
