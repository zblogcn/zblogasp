(function(){function za(a,b,c){var d;b=b.toLowerCase();return(d=a.__allListeners||c&&(a.__allListeners={}))&&(d[b]||c&&(d[b]=[]))}function Aa(a,b,c,d,e,g){d=d&&a[b];var f;for(!d&&(d=a[c]);!d&&(f=(f||a).parentNode);){if("BODY"==f.tagName||g&&!g(f))return null;d=f[c]}return d&&e&&!e(d)?Aa(d,b,c,!1,e):d}UEDITOR_CONFIG=window.UEDITOR_CONFIG||{};var q=window.baidu||{};window.baidu=q;window.UE=q.editor={};UE.plugins={};UE.commands={};UE.instants={};UE.I18N={};UE.version="1.2.6.0";var R=UE.dom={},zc=UE,
U=navigator.userAgent.toLowerCase(),Ba=window.opera,B={ie:!!window.ActiveXObject,opera:!!Ba&&Ba.version,webkit:-1<U.indexOf(" applewebkit/"),mac:-1<U.indexOf("macintosh"),quirks:"BackCompat"==document.compatMode};B.gecko="Gecko"==navigator.product&&!B.webkit&&!B.opera;var N=0;B.ie&&(N=parseFloat(U.match(/msie (\d+)/)[1]),B.ie9Compat=9==document.documentMode,B.ie8=!!document.documentMode,B.ie8Compat=8==document.documentMode,B.ie7Compat=7==N&&!document.documentMode||7==document.documentMode,B.ie6Compat=
7>N||B.quirks);if(B.gecko){var Z=U.match(/rv:([\d\.]+)/);Z&&(Z=Z[1].split("."),N=1E4*Z[0]+100*(Z[1]||0)+1*(Z[2]||0))}/chrome\/(\d+\.\d)/i.test(U)&&(B.chrome=+RegExp.$1);/(\d+\.\d)?(?:\.\d)?\s+safari\/?(\d+\.\d+)?/i.test(U)&&!/chrome/i.test(U)&&(B.safari=+(RegExp.$1||RegExp.$2));B.opera&&(N=parseFloat(Ba.version()));B.webkit&&(N=parseFloat(U.match(/ applewebkit\/(\d+)/)[1]));B.version=N;B.isCompatible=!B.mobile&&(B.ie&&6<=N||B.gecko&&10801<=N||B.opera&&9.5<=N||B.air&&1<=N||B.webkit&&522<=N||!1);var n=
zc.browser=B,I=n.ie,Ac=n.opera,Bc=UE,cb=document.createElement("div").style,db={"float":void 0!=cb.cssFloat?"cssFloat":void 0!=cb.styleFloat?"styleFloat":"float"},fb=function(a,b){try{for(var c=0,d;d=eb[c++];)if(d.doc===a&&d.url==(b.src||b.href))return d}catch(e){return null}},eb=[],$=function(a){for(a.isReady=!0;a=gb.pop();a());},gb=[],p=Bc.utils={each:function(a,b,c){if(null!=a)if(a.length===+a.length)for(var d=0,e=a.length;d<e;d++){if(!1===b.call(c,a[d],d,a))return!1}else for(d in a)if(a.hasOwnProperty(d)&&
...
b)return e.innerHTML;""!==b?e.innerHTML=b:d.removeChild(e)},sort:function(a,b){b=b||function(a,b){return a.localeCompare(b)};for(var c=0,d=a.length;c<d;c++)for(var e=c,g=a.length;e<g;e++)if(0<b(a[c],a[e])){var f=a[c];a[c]=a[e];a[e]=f}return a}};p.each("String Function Array Number RegExp Object".split(" "),function(a){UE.utils["is"+a]=function(b){return Object.prototype.toString.apply(b)=="[object "+a+"]"}});var Ca=UE.EventBase=function(){};Ca.prototype={addListener:function(a,b){a=p.trim(a).split(" ");
for(var c=0,d;d=a[c++];)za(this,d,!0).push(b)},removeListener:function(a,b){a=p.trim(a).split(" ");for(var c=0,d;d=a[c++];)p.removeItem(za(this,d)||[],b)},fireEvent:function(){for(var a=arguments[0],a=p.trim(a).split(" "),b=0,c;c=a[b++];){var d=za(this,c),e,g,f;if(d)for(f=d.length;f--;)if(d[f]){g=d[f].apply(this,arguments);if(!0===g)return g;void 0!==g&&(e=g)}if(g=this["on"+c.toLowerCase()])e=g.apply(this,arguments)}return e}};var Cc=R,hb,x=function(a){for(var b in a)a[b.toUpperCase()]=a[b];return a},
D=p.extend2,Da=x({isindex:1,fieldset:1}),ib=x({input:1,button:1,select:1,textarea:1,label:1}),jb=D(x({a:1}),ib),Ea=D({iframe:1},jb),oa=x({hr:1,ul:1,menu:1,div:1,blockquote:1,noscript:1,table:1,center:1,address:1,dir:1,pre:1,h5:1,dl:1,h4:1,noframes:1,h6:1,ol:1,h1:1,h3:1,h2:1}),kb=x({ins:1,del:1,script:1,style:1}),lb=D(x({b:1,acronym:1,bdo:1,"var":1,"#":1,abbr:1,code:1,br:1,i:1,cite:1,kbd:1,u:1,strike:1,s:1,tt:1,strong:1,q:1,samp:1,em:1,dfn:1,span:1}),kb),mb=D(x({sub:1,img:1,embed:1,object:1,sup:1,
basefont:1,map:1,applet:1,font:1,big:1,small:1}),lb),pa=D(x({p:1}),mb),nb=D(x({iframe:1}),mb,ib),ob=x({img:1,embed:1,noscript:1,br:1,kbd:1,center:1,button:1,basefont:1,h5:1,h4:1,samp:1,h6:1,ol:1,h1:1,h3:1,h2:1,form:1,font:1,"#":1,select:1,menu:1,ins:1,abbr:1,label:1,code:1,table:1,script:1,cite:1,input:1,iframe:1,strong:1,textarea:1,noframes:1,big:1,small:1,span:1,hr:1,sub:1,bdo:1,"var":1,div:1,object:1,sup:1,strike:1,dir:1,map:1,dl:1,applet:1,del:1,isindex:1,fieldset:1,ul:1,b:1,acronym:1,a:1,blockquote:1,
i:1,u:1,s:1,tt:1,address:1,q:1,pre:1,p:1,em:1,dfn:1}),u=D(x({a:0}),nb),Fa=x({tr:1}),ea=x({"#":1}),pb=D(x({param:1}),ob),K=D(x({form:1}),Da,Ea,oa,pa),qa=x({li:1,ol:1,ul:1}),Dc=x({style:1,script:1}),qb=x({base:1,link:1,meta:1,title:1}),Ec=D(qb,Dc),rb=x({head:1,body:1}),Fc=x({html:1}),sb=x({address:1,blockquote:1,center:1,dir:1,div:1,dl:1,fieldset:1,form:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,hr:1,isindex:1,menu:1,noframes:1,ol:1,p:1,pre:1,table:1,ul:1}),Gc=x({area:1,base:1,basefont:1,br:1,col:1,command:1,
dialog:1,embed:1,hr:1,img:1,input:1,isindex:1,keygen:1,link:1,meta:1,param:1,source:1,track:1,wbr:1});hb=x({$nonBodyContent:D(Fc,rb,qb),$block:sb,$inline:u,$inlineWithA:D(x({a:1}),u),$body:D(x({script:1,style:1}),sb),$cdata:x({script:1,style:1}),$empty:Gc,$nonChild:x({iframe:1,textarea:1}),$listItem:x({dd:1,dt:1,li:1}),$list:x({ul:1,ol:1,dl:1}),$isNotEmpty:x({table:1,ul:1,ol:1,dl:1,iframe:1,area:1,base:1,col:1,hr:1,img:1,embed:1,input:1,link:1,meta:1,param:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1}),$removeEmpty:x({a:1,
abbr:1,acronym:1,address:1,b:1,bdo:1,big:1,cite:1,code:1,del:1,dfn:1,em:1,font:1,i:1,ins:1,label:1,kbd:1,q:1,s:1,samp:1,small:1,span:1,strike:1,strong:1,sub:1,sup:1,tt:1,u:1,"var":1}),$removeEmptyBlock:x({p:1,div:1}),$tableContent:x({caption:1,col:1,colgroup:1,tbody:1,td:1,tfoot:1,th:1,thead:1,tr:1,table:1}),$notTransContent:x({pre:1,script:1,style:1,textarea:1}),html:rb,head:Ec,style:ea,script:ea,body:K,base:{},link:{},meta:{},title:ea,col:{},tr:x({td:1,th:1}),img:{},embed:{},colgroup:x({thead:1,
col:1,tbody:1,tr:1,tfoot:1}),noscript:K,td:K,br:{},th:K,center:K,kbd:u,button:D(pa,oa),basefont:{},h5:u,h4:u,samp:u,h6:u,ol:qa,h1:u,h3:u,option:ea,h2:u,form:D(Da,Ea,oa,pa),select:x({optgroup:1,option:1}),font:u,ins:u,menu:qa,abbr:u,label:u,table:x({thead:1,col:1,tbody:1,tr:1,colgroup:1,caption:1,tfoot:1}),code:u,tfoot:Fa,cite:u,li:K,input:{},iframe:K,strong:u,textarea:ea,noframes:K,big:u,small:u,span:x({"#":1,br:1}),hr:u,dt:u,sub:u,optgroup:x({option:1}),param:{},bdo:u,"var":u,div:K,object:pb,sup:u,
dd:K,strike:u,area:{},dir:qa,map:D(x({area:1,form:1,p:1}),Da,kb,oa),applet:pb,dl:x({dt:1,dd:1}),del:u,isindex:{},fieldset:D(x({legend:1}),ob),thead:Fa,ul:qa,acronym:u,b:u,a:D(x({a:1}),nb),blockquote:D(x({td:1,tr:1,tbody:1,li:1}),K),caption:u,i:u,u:u,tbody:Fa,s:u,address:D(Ea,pa),tt:u,legend:u,q:u,pre:D(lb,jb),p:D(x({a:1}),u),em:u,dfn:u});var t=Cc.dtd=hb,tb=I&&9>n.version?{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",
rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder"}:{tabindex:"tabIndex",readonly:"readOnly"},Hc=p.listToMap("-webkit-box -moz-box block list-item table table-row-group table-header-group table-footer-group table-row table-column-group table-column table-cell table-caption".split(" ")),f=R.domUtils={NODE_ELEMENT:1,NODE_DOCUMENT:9,NODE_TEXT:3,NODE_COMMENT:8,NODE_DOCUMENT_FRAGMENT:11,POSITION_IDENTICAL:0,POSITION_DISCONNECTED:1,POSITION_FOLLOWING:2,POSITION_PRECEDING:4,POSITION_IS_CONTAINED:8,
...
1==c.nodeType&&a.startOffset!=c.childNodes.length)return 0;for(;c!==b;){if(c.nextSibling)return 0;c=c.parentNode}return 1},isBoundaryNode:function(a,b){for(var c;!f.isBody(a);)if(c=a,a=a.parentNode,c!==a[b])return!1;return!0}},fa=RegExp(f.fillChar,"g"),ub=function(a){return!a.collapsed&&1==a.startContainer.nodeType&&a.startContainer===a.endContainer&&1==a.endOffset-a.startOffset},vb=function(a,b,c,d){if(1==b.nodeType&&(t.$empty[b.tagName]||t.$nonChild[b.tagName]))c=f.getNodeIndex(b)+(a?0:1),b=b.parentNode;
a?(d.startContainer=b,d.startOffset=c,d.endContainer||d.collapse(!0)):(d.endContainer=b,d.endOffset=c,d.startContainer||d.collapse(!1));d.collapsed=d.startContainer&&d.endContainer&&d.startContainer===d.endContainer&&d.startOffset==d.endOffset;return d},Ga=function(a,b){var c=a.startContainer,d=a.endContainer,e=a.startOffset,g=a.endOffset,h=a.document,j=h.createDocumentFragment(),l,k;1==c.nodeType&&(c=c.childNodes[e]||(l=c.appendChild(h.createTextNode(""))));1==d.nodeType&&(d=d.childNodes[g]||(k=
...
l&&f.remove(l);k&&f.remove(k);return j},wb=function(a,b){try{if(J&&f.inDoc(J,a))if(J.nodeValue.replace(fa,"").length)J.nodeValue=J.nodeValue.replace(fa,"");else{var c=J.parentNode;for(f.remove(J);c&&f.isEmptyInlineElement(c)&&(n.safari?!(f.getPosition(c,b)&f.POSITION_CONTAINS):!c.contains(b));)J=c.parentNode,f.remove(c),c=J}}catch(d){}},ra=function(a,b){var c;for(a=a[b];a&&f.isFillChar(a);)c=a[b],f.remove(a),a=c},xb=0,Ha=f.fillChar,J,yb=R.Range=function(a){this.startContainer=this.startOffset=this.endContainer=
this.endOffset=null;this.document=a;this.collapsed=!0};yb.prototype={cloneContents:function(){return this.collapsed?null:Ga(this,0)},deleteContents:function(){var a;this.collapsed||Ga(this,1);n.webkit&&(a=this.startContainer,3==a.nodeType&&!a.nodeValue.length&&(this.setStartBefore(a).collapse(!0),f.remove(a)));return this},extractContents:function(){return this.collapsed?null:Ga(this,2)},setStart:function(a,b){return vb(!0,a,b,this)},setEnd:function(a,b){return vb(!1,a,b,this)},setStartAfter:function(a){return this.setStart(a.parentNode,
...
3==a.nodeType?a.nodeValue.length:a.childNodes.length)},selectNode:function(a){return this.setStartBefore(a).setEndAfter(a)},selectNodeContents:function(a){return this.setStart(a,0).setEndAtLast(a)},cloneRange:function(){return(new yb(this.document)).setStart(this.startContainer,this.startOffset).setEnd(this.endContainer,this.endOffset)},collapse:function(a){a?(this.endContainer=this.startContainer,this.endOffset=this.startOffset):(this.startContainer=this.endContainer,this.startOffset=this.endOffset);
...
b!==d.end;)c=f.getNextDomNode(b,!0,function(a){return 1==a.nodeType}),-1<p.indexOf(a,b.tagName.toLowerCase())&&f.remove(b,!0),b=c;return this.moveToBookmark(d)},getClosedNode:function(){var a;if(!this.collapsed){var b=this.cloneRange().adjustmentBoundary().shrinkBoundary();if(ub(b)&&(b=b.startContainer.childNodes[b.startOffset])&&1==b.nodeType&&(t.$empty[b.tagName]||t.$nonChild[b.tagName]))a=b}return a},select:n.ie?function(a,b){var c;this.collapsed||this.shrinkBoundary();var d=this.getClosedNode();
if(d&&!b){try{c=this.document.body.createControlRange(),c.addElement(d),c.select()}catch(e){}return this}var d=this.createBookmark(),g=d.start;c=this.document.body.createTextRange();c.moveToElementText(g);c.moveStart("character",1);if(this.collapsed){if(!a&&3!=this.startContainer.nodeType){var h=this.document.createTextNode(Ha),j=this.document.createElement("span");j.appendChild(this.document.createTextNode(Ha));g.parentNode.insertBefore(j,g);g.parentNode.insertBefore(h,g);wb(this.document,h);J=h;
...
b.nodeType&&this.startOffset)&&(a?!a.previousSibling||3!=a.previousSibling.nodeType:!b.lastChild||3!=b.lastChild.nodeType)))a=this.document.createTextNode(Ha),this.insertNode(a),wb(this.document,a),ra(a,"previousSibling"),ra(a,"nextSibling"),J=a,this.setStart(a,n.webkit?1:0).collapse(!0);b=this.document.createRange();if(this.collapsed&&n.opera&&1==this.startContainer.nodeType)if(a=this.startContainer.childNodes[this.startOffset]){for(;a&&f.isBlockElm(a);)if(1==a.nodeType&&a.childNodes[0])a=a.childNodes[0];
...
for(var c=this.createBookmark(),d=c.end,e=f.getNextDomNode(c.start,!1,b);e&&e!==d&&f.getPosition(e,d)&f.POSITION_PRECEDING;){var g=f.getNextDomNode(e,!1,b);a(e);e=g}return this.moveToBookmark(c)}};var zb=function(a,b){var c=f.getNodeIndex;a=a.duplicate();a.collapse(b);var d=a.parentElement();if(!d.hasChildNodes())return{container:d,offset:0};for(var e=d.children,g,h=a.duplicate(),j=0,l=e.length-1,k=-1;j<=l;){k=Math.floor((j+l)/2);g=e[k];h.moveToElementText(g);var m=h.compareEndPoints("StartToStart",
...
"empty":"removeAllRanges"]()}};var sa=function(a,b){var c;if(b.textarea)if(p.isString(b.textarea))for(var d=0,e,g=f.getElementsByTagName(a,"textarea");e=g[d++];){if(e.id=="ueditor_textarea_"+b.options.textarea){c=e;break}}else c=b.textarea;c||(a.appendChild(c=f.createElement(document,"textarea",{name:b.options.textarea,id:"ueditor_textarea_"+b.options.textarea,style:"display:none"})),b.textarea=c);c.value=b.hasContents()?b.options.allHtmlEnabled?b.getAllHtml():b.getContent(null,null,!0):""},Ic=0,
Ab,Bb=UE.Editor=function(a){var b=this;b.uid=Ic++;Ca.call(b);b.commands={};b.options=p.extend(p.clone(a||{}),UEDITOR_CONFIG,!0);b.shortcutkeys={};b.inputRules=[];b.outputRules=[];b.setOpt({isShow:!0,initialContent:"",initialStyle:"",autoClearinitialContent:!1,iframeCssUrl:b.options.UEDITOR_HOME_URL+"themes/iframe.css",textarea:"editorValue",focus:!1,focusInEnd:!0,autoClearEmptyNode:!0,fullscreen:!1,readonly:!1,zIndex:999,imagePopup:!0,enterTag:"p",customDomain:!1,lang:"zh-cn",langPath:b.options.UEDITOR_HOME_URL+
"lang/",theme:"default",themePath:b.options.UEDITOR_HOME_URL+"themes/",allHtmlEnabled:!1,scaleEnabled:!1,tableNativeEditInFF:!1,autoSyncData:!0});p.loadFile(document,{src:b.options.langPath+b.options.lang+"/"+b.options.lang+".js",tag:"script",type:"text/javascript",defer:"defer"},function(){for(var a in UE.plugins)UE.plugins[a].call(b);b.langIsReady=!0;b.fireEvent("langReady")});UE.instants["ueditorInstant"+b.uid]=b},Cb=function(){var a=this;a.document.getElementById("initContent")&&(a.body.innerHTML=
"<p>"+(I?"":"<br/>")+"</p>",a.removeListener("firstBeforeExecCommand focus",Cb),setTimeout(function(){a.focus();a._selectionChange()},0))};Bb.prototype={ready:function(a){a&&(this.isReady?a.apply(this):this.addListener("ready",a))},setOpt:function(a,b){var c={};p.isString(a)?c[a]=b:c=a;p.extend(this.options,c,!0)},destroy:function(){this.fireEvent("destroy");var a=this.container.parentNode,b=this.textarea;b?b.style.display="":(b=document.createElement("textarea"),a.parentNode.insertBefore(b,a));b.style.width=
...
b.innerHTML=c.toHTML(e)}}d=0},200)}:function(a){d||(a.preventDefault?a.preventDefault():a.returnValue=!1);d=0})},_proxyDomEvent:function(a){return this.fireEvent(a.type.replace(/^on/,""),a)},_selectionChange:function(a,b){var c=this,d=!1,e,g;n.ie&&(9>n.version&&b&&"mouseup"==b.type)&&!this.selection.getRange().collapsed&&(d=!0,e=b.clientX,g=b.clientY);clearTimeout(Ab);Ab=setTimeout(function(){if(c.selection.getNative()){var a;if(d&&"None"==c.selection.getNative().type){a=c.document.body.createTextRange();
...
a)},addOutputRule:function(a){this.outputRules.push(a)},filterOutputRule:function(a){for(var b=0,c;c=this.outputRules[b++];)c.call(this,a)}};p.inherits(Bb,Ca);var Jc=UE,Db=function(a){var b=[],c;for(c in a)"method"==c||"timeout"==c||"async"==c||"function"==(typeof a[c]).toLowerCase()||"object"==(typeof a[c]).toLowerCase()||b.push(encodeURIComponent(c)+"="+encodeURIComponent(a[c]));return b.join("&")},Ja="XMLHttpRequest()";try{new ActiveXObject("Msxml2.XMLHTTP"),Ja="ActiveXObject('Msxml2.XMLHTTP')"}catch(Rd){try{new ActiveXObject("Microsoft.XMLHTTP"),
Ja="ActiveXObject('Microsoft.XMLHTTP')"}catch(Sd){}}var Kc=new Function("return new "+Ja);Jc.ajax={request:function(a,b){var c=Kc(),d=!1,e={method:"POST",timeout:5E3,async:!0,data:{},onsuccess:function(){},onerror:function(){}};"object"===typeof a&&(b=a,a=b.url);if(c&&a){var g=b?p.extend(e,b):e,e=Db(g);p.isEmptyObject(g.data)||(e+=(e?"&":"")+Db(g.data));var f=setTimeout(function(){4!=c.readyState&&(d=!0,c.abort(),clearTimeout(f))},g.timeout),j=g.method.toUpperCase(),l=a+(-1==a.indexOf("?")?"?":"&")+
...
a};var ta=function(a,b,c){a.push(Lc);return b+(c?1:-1)},ua=function(a,b){for(var c=0;c<b;c++)a.push(Mc)},Ka=function(a,b,c,d){switch(a.type){case "root":for(var e=0,f;f=a.children[e++];)c&&("element"==f.type&&!t.$inlineWithA[f.tagName]&&1<e)&&(ta(b,d,!0),ua(b,d)),Ka(f,b,c,d);break;case "text":b.push("pre"==a.parentNode.tagName?a.data:a.data.replace(/[ ]{2}/g," &nbsp;"));break;case "element":f="";if(a.attrs){f=[];var h=a.attrs;for(e in h)f.push(e+(void 0!==h[e]?'="'+p.unhtml(h[e])+'"':""));f=f.join(" ")}b.push("<"+
a.tagName+(f?" "+f:"")+(t.$empty[a.tagName]?"/":"")+">");c&&(!t.$inlineWithA[a.tagName]&&"pre"!=a.tagName)&&(a.children&&a.children.length)&&(d=ta(b,d,!0),ua(b,d));if(a.children&&a.children.length)for(e=0;f=a.children[e++];)c&&("element"==f.type&&!t.$inlineWithA[f.tagName]&&1<e)&&(ta(b,d),ua(b,d)),Ka(f,b,c,d);t.$empty[a.tagName]||(c&&(!t.$inlineWithA[a.tagName]&&"pre"!=a.tagName)&&(a.children&&a.children.length)&&(d=ta(b,d),ua(b,d)),b.push("</"+a.tagName+">"));break;case "comment":b.push("\x3c!--"+
a.data+"--\x3e")}return b},Eb=function(a,b){var c;if("element"==a.type&&a.getAttr("id")==b)return a;if(a.children&&a.children.length)for(var d=0;c=a.children[d++];)if(c=Eb(c,b))return c},Fb=function(a,b,c){"element"==a.type&&a.tagName==b&&c.push(a);if(a.children&&a.children.length)for(var d=0,e;e=a.children[d++];)Fb(e,b,c)},Gb=function(a,b){if(a.children&&a.children.length)for(var c=0,d;d=a.children[c];)Gb(d,b),d.parentNode&&(d.children&&d.children.length&&b(d),d.parentNode&&c++);else b(a)},ga=UE.uNode=
function(a){this.type=a.type;this.data=a.data;this.tagName=a.tagName;this.parentNode=a.parentNode;this.attrs=a.attrs||{};this.children=a.children},Mc="    ",Lc="\n";ga.createElement=function(a){return/[<>]/.test(a)?UE.htmlparser(a).children[0]:new ga({type:"element",children:[],tagName:a})};ga.createText=function(a){return new UE.uNode({type:"text",data:p.unhtml(a||"")})};ga.prototype={toHtml:function(a){var b=[];Ka(this,b,a,0);return b.join("")},innerHTML:function(a){if("element"!=this.type||t.$empty[this.tagName])return this;
...
if(this.children&&this.children.length)for(var c=0;b=this.children[c++];)if(b=Eb(b,a))return b},getNodesByTagName:function(a){a=p.trim(a).replace(/[ ]{2,}/g," ").split(" ");var b=[],c=this;p.each(a,function(a){if(c.children&&c.children.length)for(var e=0,f;f=c.children[e++];)Fb(f,a,b)});return b},getStyle:function(a){var b=this.getAttr("style");return!b?"":(a=b.match(RegExp(a+":([^;]+)","i")))&&a[0]?a[1]:""},setStyle:function(a,b){function c(a,b){d=d.replace(RegExp(a+":([^;]+;?)","gi"),"");b&&(d=
a+":"+p.unhtml(b)+";"+d)}var d=this.getAttr("style");d||(d="");if(p.isObject(a))for(var e in a)c(e,a[e]);else c(a,b);this.setAttr("style",d)},traversal:function(a){this.children&&this.children.length&&Gb(this,a);return this}};UE.htmlparser=function(a,b){function c(a,b){if(k[a.tagName]){var c=j.createElement(k[a.tagName]);a.appendChild(c);c.appendChild(j.createText(b))}else a.appendChild(j.createText(b))}function d(a,b,c){var e;if(e=l[b]){for(var f=a,h;"root"!=f.type;){if(p.isArray(e)?-1!=p.indexOf(e,
...
!f.isWhitespace(a)};e.enlarge(!0);for(var l=e.createBookmark(),k=f.getNextDomNode(l.start,!1,j),m=e.cloneRange(),n;k&&!(f.getPosition(k,l.end)&f.POSITION_FOLLOWING);)if(3==k.nodeType||!a(k)){for(m.setStartBefore(k);k&&k!==l.end&&!a(k);)n=k,k=f.getNextDomNode(k,!1,null,function(b){return!a(b)});m.setEndAfter(n);k=m.getCommonAncestor();if(!f.isBody(k)&&a(k))f.setStyles(k,p.isString(d)?{"text-align":d}:d);else{k=e.document.createElement("p");f.setStyles(k,p.isString(d)?{"text-align":d}:d);var q=m.extractContents();
k.appendChild(q);m.insertNode(k)}k=f.getNextDomNode(k,!1,j)}else k=f.getNextDomNode(k,!0,j);e.moveToBookmark(l).moveToBookmark(h);g&&(e.setStartBefore(g).collapse(!0),f.remove(g));e.select();return!0},queryCommandValue:function(){var a=this.selection.getStart(),a=f.getComputedStyle(a,"text-align");return b[a]?a:"left"},queryCommandState:function(){var a=this.selection.getStart();return a&&f.findParentByTagName(a,["td","th","caption"],!0)?-1:0}}};UE.plugins.font=function(){function a(a){var b=a.collapsed,
c=a.createBookmark();if(b)for(b=c.start.parentNode;t.$inline[b.tagName];)b=b.parentNode;else b=f.getCommonAncestor(c.start,c.end);p.each(f.getElementsByTagName(b,"span"),function(a){if(a.parentNode&&!f.isBookmarkNode(a))if(/^\s*border\s*:\s*none;\s*/i.test(a.style.cssText))f.remove(a,!0);else{/border/i.test(a.style.cssText)&&("SPAN"==a.parentNode.tagName&&/border/i.test(a.parentNode.style.cssText))&&(a.style.cssText=a.style.cssText.replace(/border[^:]*:[^;]+;?/gi,""));for(var b=a.nextSibling;b&&1==
b.nodeType&&"SPAN"==b.tagName;){f.isBookmarkNode(b)?a.appendChild(b):b.style.cssText==a.style.cssText&&(f.moveChild(b,a),f.remove(b));if(a.nextSibling===b)break;b=a.nextSibling}}});a.moveToBookmark(c)}var b={forecolor:"color",backcolor:"background-color",fontsize:"font-size",fontfamily:"font-family",underline:"text-decoration",strikethrough:"text-decoration",fontborder:"border"},c={underline:1,strikethrough:1,fontborder:1};this.setOpt({fontfamily:[{name:"songti",val:"\u5b8b\u4f53,SimSun"},{name:"yahei",
val:"\u5fae\u8f6f\u96c5\u9ed1,Microsoft YaHei"},{name:"kaiti",val:"\u6977\u4f53,\u6977\u4f53_GB2312, SimKai"},{name:"heiti",val:"\u9ed1\u4f53, SimHei"},{name:"lishu",val:"\u96b6\u4e66, SimLi"},{name:"andaleMono",val:"andale mono"},{name:"arial",val:"arial, helvetica,sans-serif"},{name:"arialBlack",val:"arial black,avant garde"},{name:"comicSansMs",val:"comic sans ms"},{name:"impact",val:"impact,chicago"},{name:"timesNewRoman",val:"times new roman"}],fontsize:[10,11,12,14,16,18,20,24,36]});this.addInputRule(function(a){p.each(a.getNodesByTagName("u s del font"),
function(a){if("font"==a.tagName){var b=[],c;for(c in a.attrs)switch(c){case "size":b.push("font-size:"+a.attrs[c]+"px");break;case "color":b.push("color:"+a.attrs[c]);break;case "face":b.push("font-family:"+a.attrs[c]);break;case "style":b.push(a.attrs[c])}a.attrs={style:b.join(";")}}else b="u"==a.tagName?"underline":"line-through",a.attrs={style:(a.getAttr("style")||"")+"text-decoration:"+b+";"};a.tagName="span"})});for(var d in b)(function(b,d){UE.commands[b]={execCommand:function(h,j){j=j||(this.queryCommandState(h)?
"none":"underline"==h?"underline":"fontborder"==h?"1px solid #000":"line-through");var l=this,k=this.selection.getRange(),m;if("default"==j)k.collapsed&&(m=l.document.createTextNode("font"),k.insertNode(m).select()),l.execCommand("removeFormat","span,a",d),m&&(k.setStartBefore(m).setCursor(),f.remove(m));else if(k.collapsed){var p=f.findParentByTagName(k.startContainer,"span",!0);m=l.document.createTextNode("font");if(p&&!p.children.length&&!p[n.ie?"innerText":"textContent"].replace(fa,"").length)k.insertNode(m),
c[b]&&(k.selectNode(m).select(),l.execCommand("removeFormat","span,a",d,null),p=f.findParentByTagName(m,"span",!0),k.setStartBefore(m)),p&&(p.style.cssText+=";"+d+":"+j),k.collapse(!0).select();else{k.insertNode(m);k.selectNode(m).select();p=k.document.createElement("span");if(c[b]){if(f.findParentByTagName(m,"a",!0)){k.setStartBefore(m).setCursor();f.remove(m);return}l.execCommand("removeFormat","span,a",d)}p.style.cssText=d+":"+j;m.parentNode.insertBefore(p,m);if(!n.ie||n.ie&&9==n.version)for(var q=
p.parentNode;!f.isBlockElm(q);)"SPAN"==q.tagName&&(p.style.cssText=q.style.cssText+";"+p.style.cssText),q=q.parentNode;Ac?setTimeout(function(){k.setStart(p,0).collapse(!0);a(k,l);k.select()}):(k.setStart(p,0).collapse(!0),a(k,l),k.select())}f.remove(m)}else c[b]&&l.queryCommandValue(b)&&l.execCommand("removeFormat","span,a",d),k=l.selection.getRange(),k.applyInlineStyle("span",{style:d+":"+j}),a(k,l),k.select();return!0},queryCommandValue:function(a){var b=this.selection.getStart();if("underline"==
a||"strikethrough"==a){for(var c=b;c&&!f.isBlockElm(c)&&!f.isBody(c);){if(1==c.nodeType&&(a=f.getComputedStyle(c,d),"none"!=a))return a;c=c.parentNode}return"none"}if("fontborder"==a){for(a=b;a&&t.$inline[a.tagName];){if((c=f.getComputedStyle(a,"border"))&&/1px/.test(c)&&/solid/.test(c))return c;a=a.parentNode}return""}return f.getComputedStyle(b,d)},queryCommandState:function(a){if(!c[a])return 0;var b=this.queryCommandValue(a);return"fontborder"==a?/1px/.test(b)&&/solid/.test(b):b==("underline"==
a?"underline":"line-through")}}})(d,b[d])};UE.plugins.link=function(){function a(a){var c=a.startContainer,d=a.endContainer;(c=f.findParentByTagName(c,"a",!0))&&a.setStartBefore(c);(d=f.findParentByTagName(d,"a",!0))&&a.setEndAfter(d)}UE.commands.unlink={execCommand:function(){var b=this.selection.getRange(),c;if(!b.collapsed||f.findParentByTagName(b.startContainer,"a",!0))c=b.createBookmark(),a(b),b.removeInlineStyle("a").moveToBookmark(c).select()},queryCommandState:function(){return!this.highlight&&
this.queryCommandValue("link")?0:-1}};UE.commands.link={execCommand:function(b,c){var d;c._href&&(c._href=p.unhtml(c._href,/[<">]/g));c.href&&(c.href=p.unhtml(c.href,/[<">]/g));c.textValue&&(c.textValue=p.unhtml(c.textValue,/[<">]/g));var e=d=this.selection.getRange(),g=e.cloneRange(),h=this.queryCommandValue("link");a(e=e.adjustmentBoundary());var j=e.startContainer;if(1==j.nodeType&&h&&(j=j.childNodes[e.startOffset])&&1==j.nodeType&&"A"==j.tagName&&/^(?:https?|ftp|file)\s*:\s*\/\//.test(j[n.ie?
"innerText":"textContent"]))j[n.ie?"innerText":"textContent"]=p.html(c.textValue||c.href);if(!g.collapsed||h)e.removeInlineStyle("a"),g=e.cloneRange();if(g.collapsed){var h=e.document.createElement("a"),l="";c.textValue?(l=p.html(c.textValue),delete c.textValue):l=p.html(c.href);f.setAttributes(h,c);(j=f.findParentByTagName(g.startContainer,"a",!0))&&f.isInNodeEndBoundary(g,j)&&e.setStartAfter(j).collapse(!0);h[n.ie?"innerText":"textContent"]=l;e.insertNode(h).selectNode(h)}else e.applyInlineStyle("a",
c);d.collapse().select(!0)},queryCommandValue:function(){var a=this.selection.getRange(),c;if(a.collapsed){if(c=a.startContainer,(c=1==c.nodeType?c:c.parentNode)&&(c=f.findParentByTagName(c,"a",!0))&&!f.isInNodeEndBoundary(a,c))return c}else{a.shrinkBoundary();var d=3==a.startContainer.nodeType||!a.startContainer.childNodes[a.startOffset]?a.startContainer:a.startContainer.childNodes[a.startOffset],e=3==a.endContainer.nodeType||0==a.endOffset?a.endContainer:a.endContainer.childNodes[a.endOffset-1],
a=a.getCommonAncestor();c=f.findParentByTagName(a,"a",!0);if(!c&&1==a.nodeType)for(var a=a.getElementsByTagName("a"),g,h,j=0,l;l=a[j++];)if(g=f.getPosition(l,d),h=f.getPosition(l,e),(g&f.POSITION_FOLLOWING||g&f.POSITION_CONTAINS)&&(h&f.POSITION_PRECEDING||h&f.POSITION_CONTAINS)){c=l;break}return c}},queryCommandState:function(){var a=this.selection.getRange().getClosedNode();return a&&"edui-faked-video"==a.className?-1:0}}};UE.plugins.insertframe=function(){var a=this;a.addListener("selectionchange",
function(){a._iframe&&delete a._iframe})};UE.commands.scrawl={queryCommandState:function(){return n.ie&&8>=n.version?-1:0}};UE.plugins.removeformat=function(){this.setOpt({removeFormatTags:"b,big,code,del,dfn,em,font,i,ins,kbd,q,samp,small,span,strike,strong,sub,sup,tt,u,var",removeFormatAttributes:"class,style,lang,width,height,align,hspace,valign"});this.commands.removeformat={execCommand:function(a,b,c,d,e){function g(a){if(3==a.nodeType||"span"!=a.tagName.toLowerCase())return 0;if(n.ie){var b=
a.attributes;if(b.length){a=0;for(var c=b.length;a<c;a++)if(b[a].specified)return 0;return 1}}return!a.attributes.length}b=RegExp("^(?:"+(b||this.options.removeFormatTags).replace(/,/g,"|")+")$","i");var h=c?[]:(d||this.options.removeFormatAttributes).split(",");d=new R.Range(this.document);var j,l=function(a){return 1==a.nodeType};a=d=this.selection.getRange();var k=a.createBookmark();a.collapsed&&a.enlarge(!0);e||((e=f.findParentByTagName(a.startContainer,"a",!0))&&a.setStartBefore(e),(e=f.findParentByTagName(a.endContainer,
"a",!0))&&a.setEndAfter(e));e=a.createBookmark();for(m=e.start;(j=m.parentNode)&&!f.isBlockElm(j);)f.breakParent(m,j),f.clearEmptySibling(m);if(e.end){for(m=e.end;(j=m.parentNode)&&!f.isBlockElm(j);)f.breakParent(m,j),f.clearEmptySibling(m);for(j=f.getNextDomNode(e.start,!1,l);j&&j!=e.end;)m=f.getNextDomNode(j,!0,l),!t.$empty[j.tagName.toLowerCase()]&&!f.isBookmarkNode(j)&&(b.test(j.tagName)?c?(f.removeStyle(j,c),g(j)&&"text-decoration"!=c&&f.remove(j,!0)):f.remove(j,!0):!t.$tableContent[j.tagName]&&
!t.$list[j.tagName]&&(f.removeAttributes(j,h),g(j)&&f.remove(j,!0))),j=m}c=e.start.parentNode;f.isBlockElm(c)&&(!t.$tableContent[c.tagName]&&!t.$list[c.tagName])&&f.removeAttributes(c,h);c=e.end.parentNode;e.end&&(f.isBlockElm(c)&&!t.$tableContent[c.tagName]&&!t.$list[c.tagName])&&f.removeAttributes(c,h);a.moveToBookmark(e).moveToBookmark(k);var m=a.startContainer;for(b=a.collapsed;1==m.nodeType&&f.isEmptyNode(m)&&t.$removeEmpty[m.tagName];)c=m.parentNode,a.setStartBefore(m),a.startContainer===a.endContainer&&
a.endOffset--,f.remove(m),m=c;if(!b)for(m=a.endContainer;1==m.nodeType&&f.isEmptyNode(m)&&t.$removeEmpty[m.tagName];)c=m.parentNode,a.setEndBefore(m),f.remove(m),m=c;d.select()}}};UE.plugins.blockquote=function(){this.commands.blockquote={execCommand:function(a,b){var c=this.selection.getRange(),d=f.filterNodeList(this.selection.getStartElementPath(),"blockquote"),e=t.blockquote,g=c.createBookmark();if(d){var e=c.startContainer,e=f.isBlockElm(e)?e:f.findParent(e,function(a){return f.isBlockElm(a)}),
h=c.endContainer,h=f.isBlockElm(h)?h:f.findParent(h,function(a){return f.isBlockElm(a)}),e=f.findParentByTagName(e,"li",!0)||e,h=f.findParentByTagName(h,"li",!0)||h;"LI"==e.tagName||"TD"==e.tagName||e===d||f.isBody(e)?f.remove(d,!0):f.breakParent(e,d);e!==h&&(d=f.findParentByTagName(h,"blockquote"))&&("LI"==h.tagName||"TD"==h.tagName||f.isBody(h)?d.parentNode&&f.remove(d,!0):f.breakParent(h,d));for(var j=f.getElementsByTagName(this.document,"blockquote"),d=0,l;l=j[d++];)l.childNodes.length?f.getPosition(l,
e)&f.POSITION_FOLLOWING&&f.getPosition(l,h)&f.POSITION_PRECEDING&&f.remove(l,!0):f.remove(l)}else{d=c.cloneRange();j=h=1==d.startContainer.nodeType?d.startContainer:d.startContainer.parentNode;for(l=1;;){if(f.isBody(h)){j!==h?c.collapsed?(d.selectNode(j),l=0):d.setStartBefore(j):d.setStart(h,0);break}if(!e[h.tagName]){c.collapsed?d.selectNode(j):d.setStartBefore(j);break}j=h;h=h.parentNode}if(l)for(j=h=h=1==d.endContainer.nodeType?d.endContainer:d.endContainer.parentNode;;){if(f.isBody(h)){j!==h?
d.setEndAfter(j):d.setEnd(h,h.childNodes.length);break}if(!e[h.tagName]){d.setEndAfter(j);break}j=h;h=h.parentNode}h=c.document.createElement("blockquote");f.setAttributes(h,b);h.appendChild(d.extractContents());d.insertNode(h);e=f.getElementsByTagName(h,"blockquote");for(d=0;h=e[d++];)h.parentNode&&f.remove(h,!0)}c.moveToBookmark(g).select()},queryCommandState:function(){return f.filterNodeList(this.selection.getStartElementPath(),"blockquote")?1:0}}};UE.commands.indent={execCommand:function(){var a=
...
{execCommand:function(a){if(-1!==this.queryCommandState(a)){this.execCommand("insertHtml","<hr>");a=this.selection.getRange();var b=a.startContainer;if(1==b.nodeType&&!b.childNodes[a.startOffset]){var c;if((c=b.childNodes[a.startOffset-1])&&1==c.nodeType&&"HR"==c.tagName)"p"==this.options.enterTag?(c=this.document.createElement("p"),a.insertNode(c),a.setStart(c,0).setCursor()):(c=this.document.createElement("br"),a.insertNode(c),a.setStartBefore(c).setCursor())}return!0}},queryCommandState:function(){return f.filterNodeList(this.selection.getStartElementPath(),
"table")?-1:0}};this.addListener("delkeyup",function(){var a=this.selection.getRange();f.isBody(a.startContainer)&&(a=a.startContainer.childNodes[a.startOffset-1])&&"HR"==a.nodeName&&f.remove(a)})};UE.commands.time=UE.commands.date={execCommand:function(a){var b=new Date;this.execCommand("insertHtml","time"==a?b.getHours()+":"+(10>b.getMinutes()?"0"+b.getMinutes():b.getMinutes())+":"+(10>b.getSeconds()?"0"+b.getSeconds():b.getSeconds()):b.getFullYear()+"-"+(10>b.getMonth()+1?"0"+(b.getMonth()+1):
b.getMonth()+1)+"-"+(10>b.getDate()?"0"+b.getDate():b.getDate()))}};UE.plugins.rowspacing=function(){this.setOpt({rowspacingtop:["5","10","15","20","25"],rowspacingbottom:["5","10","15","20","25"]});this.commands.rowspacing={execCommand:function(a,b,c){this.execCommand("paragraph","p",{style:"margin-"+c+":"+b+"px"});return!0},queryCommandValue:function(a,b){var c=f.filterNodeList(this.selection.getStartElementPath(),function(a){return f.isBlockElm(a)});return c?(c=f.getComputedStyle(c,"margin-"+b).replace(/[^\d]/g,
""),!c?0:c):0}}};UE.plugins.lineheight=function(){this.setOpt({lineheight:"1 1.5 1.75 2 3 4 5".split(" ")});this.commands.lineheight={execCommand:function(a,b){this.execCommand("paragraph","p",{style:"line-height:"+("1"==b?"normal":b+"em")});return!0},queryCommandValue:function(){var a=f.filterNodeList(this.selection.getStartElementPath(),function(a){return f.isBlockElm(a)});if(a)return a=f.getComputedStyle(a,"line-height"),"normal"==a?1:a.replace(/[^\d.]*/ig,"")}}};UE.plugins.insertcode=function(){var a=
this;a.ready(function(){p.cssRule("pre","pre{margin:.5em 0;padding:.4em .6em;border-radius:8px;background:#f8f8f8;line-height:1.5}",a.document)});a.setOpt("insertcode",{as3:"ActionScript3",bash:"Bash/Shell",cpp:"C/C++",css:"Css",cf:"CodeFunction","c#":"C#",delphi:"Delphi",diff:"Diff",erlang:"Erlang",groovy:"Groovy",html:"Html",java:"Java",jfx:"JavaFx",js:"Javascript",pl:"Perl",php:"Php",plain:"Plain Text",ps:"PowerShell",python:"Python",ruby:"Ruby",scala:"Scala",sql:"Sql",vb:"Vb",xml:"Xml"});a.commands.insertcode=
{execCommand:function(a,c){var d=this.selection.getRange(),e=f.findParentByTagName(d.startContainer,"pre",!0);if(e)e.className="brush:"+c+";toolbar:false;";else{var g="";d.collapsed?g=n.ie?8<n.version?"":"&nbsp;":"<br/>":(e=d.extractContents(),d=this.document.createElement("div"),d.appendChild(e),p.each(UE.filterNode(UE.htmlparser(d.innerHTML.replace(/[\r\t]/g,"")),this.options.filterTxtRules).children,function(a){n.ie&&8<n.version?("element"==a.type?"br"==a.tagName?g+="\n":t.$empty[a.tagName]||(p.each(a.children,
function(b){"element"==b.type?"br"==b.tagName?g+="\n":t.$empty[a.tagName]||(g+=b.innerText()):g+=b.data}),/\n$/.test(g)||(g+="\n")):g+=a.data+"\n",!a.nextSibling()&&/\n$/.test(g)&&(g=g.replace(/\n$/,""))):n.ie?("element"==a.type?"br"==a.tagName?g+="<br>":t.$empty[a.tagName]||(p.each(a.children,function(b){"element"==b.type?"br"==b.tagName?g+="<br>":t.$empty[a.tagName]||(g+=b.innerText()):g+=b.data}),/br>$/.test(g)||(g+="<br>")):g+=a.data+"<br>",!a.nextSibling()&&/<br>$/.test(g)&&(g=g.replace(/<br>$/,
""))):(g+="element"==a.type?t.$empty[a.tagName]?"":a.innerText():a.data,!/br\/?\s*>$/.test(g)&&a.nextSibling()&&(g+="<br>"))}));this.execCommand("inserthtml",'<pre id="coder"class="brush:'+c+';toolbar:false">'+g+"</pre>",!0);e=this.document.getElementById("coder");f.removeAttributes(e,"id");(d=e.previousSibling)&&f.isEmptyBlock(d)&&f.remove(d);d=this.selection.getRange();f.isEmptyBlock(e)?d.setStart(e,0).setCursor(!1,!0):d.selectNodeContents(e).select()}},queryCommandValue:function(){var a=this.selection.getStartElementPath(),
c="";p.each(a,function(a){if("PRE"==a.nodeName)return c=(a=a.className.match(/brush:([^;]+)/))&&a[1]?a[1]:"",!1});return c}};a.addInputRule(function(a){p.each(a.getNodesByTagName("pre"),function(a){var b=a.getNodesByTagName("br");b.length?n.ie&&8<n.version&&p.each(b,function(a){var b=UE.uNode.createText("\n");a.parentNode.insertBefore(b,a);a.parentNode.removeChild(a)}):n.ie&&8<n.version||(b=a.innerText().split(/\n/),a.innerHTML(""),p.each(b,function(b){b.length&&a.appendChild(UE.uNode.createText(b));
a.appendChild(UE.uNode.createElement("br"))}))})});a.addOutputRule(function(a){p.each(a.getNodesByTagName("pre"),function(a){var b="";p.each(a.children,function(a){b="text"==a.type?b+a.data.replace(/[ ]/g,"&nbsp;"):b+"\n"});a.innerText(b.replace(/(&nbsp;|\n)+$/,""))})});a.notNeedCodeQuery={help:1,undo:1,redo:1,source:1,print:1,searchreplace:1,fullscreen:1,preview:1,insertparagraph:1,elementpath:1,highlightcode:1,insertcode:1,inserthtml:1,selectall:1};a.queryCommandState=function(a){return!this.notNeedCodeQuery[a.toLowerCase()]&&
this.selection&&this.queryCommandValue("insertcode")?-1:UE.Editor.prototype.queryCommandState.apply(this,arguments)};a.addListener("beforeenterkeydown",function(){var b=a.selection.getRange(),c=f.findParentByTagName(b.startContainer,"pre",!0);if(c){a.fireEvent("saveScene");b.collapsed||b.deleteContents();if(n.ie)if(8<n.version){var c=a.document.createTextNode("\n"),d=b.startContainer;if(0==b.startOffset){if(d.previousSibling){b.insertNode(c);var e=a.document.createTextNode(" ");b.setStartAfter(c).insertNode(e).setStart(e,
...
a.type?"br"==a.tagName?j.appendChild(d.document.createElement("br")):t.$empty[a.tagName]||(p.each(a.children,function(b){"element"==b.type?"br"==b.tagName?j.appendChild(d.document.createElement("br")):t.$empty[a.tagName]||j.appendChild(d.document.createTextNode(p.html(b.innerText().replace(/&nbsp;/g," ")))):j.appendChild(d.document.createTextNode(p.html(b.data.replace(/&nbsp;/g," "))))}),"BR"!=j.lastChild.nodeName&&j.appendChild(d.document.createElement("br"))):j.appendChild(d.document.createTextNode(p.html(a.data.replace(/&nbsp;/g,
...
"td th caption p"),function(b){f.isEmptyNode(b)&&f.fillNode(a.document,b)});try{var d=(new R.Range(a.document)).moveToAddress(b.address);d.select(h[d.startContainer.nodeName.toLowerCase()])}catch(e){}this.update();this.clearKey();a.fireEvent("reset",!0)};this.getScene=function(){var a=this.editor,b=a.selection.getRange().createAddress(!1,!0);a.fireEvent("beforegetscene");var c=UE.htmlparser(a.body.innerHTML,!0);a.options.autoClearEmptyNode=!1;a.filterOutputRule(c);a.options.autoClearEmptyNode=j;c=
...
b+"="+c+" ":""});return{span:1,div:1}[c]?"":"<"+b+c+" "+p.trim(d)+">"}):h&&(j=c);b.execCommand("inserthtml",j,!0);b.__hasEnterExecCommand=!1;j=b.selection.getRange().createAddress(!0);e.endAddress=j.startAddress}});b.addListener("ready",function(){f.on(b.body,"cut",function(){!b.selection.getRange().collapsed&&b.undoManger&&b.undoManger.save()});f.on(b.body,n.ie||n.opera?"keydown":"paste",function(g){(!n.ie&&!n.opera||!(!g.ctrlKey&&!g.metaKey||"86"!=g.keyCode))&&a.call(b,function(a){var g;if(a.firstChild){var l=
f.getElementsByTagName(a,"span");g=0;for(var k;k=l[g++];)("_baidu_cut_start"==k.id||"_baidu_cut_end"==k.id)&&f.remove(k);if(n.webkit){k=a.querySelectorAll("div br");for(g=0;l=k[g++];)l=l.parentNode,"DIV"==l.tagName&&1==l.childNodes.length&&(l.innerHTML="<p><br/></p>",f.remove(l));l=a.querySelectorAll("#baidu_pastebin");for(g=0;k=l[g++];){var m=b.document.createElement("p");for(k.parentNode.insertBefore(m,k);k.firstChild;)m.appendChild(k.firstChild);f.remove(k)}k=a.querySelectorAll("meta");for(g=0;l=
k[g++];)f.remove(l);k=a.querySelectorAll("br");for(g=0;l=k[g++];)/^apple-/i.test(l.className)&&f.remove(l)}if(n.gecko){k=a.querySelectorAll("[_moz_dirty]");for(g=0;l=k[g++];)l.removeAttribute("_moz_dirty")}if(!n.ie){k=a.querySelectorAll("span.Apple-style-span");for(g=0;l=k[g++];)f.remove(l,!0)}g=a.innerHTML;g=UE.filterWord(g);a=UE.htmlparser(g,!0);b.options.filterRules&&UE.filterNode(a,b.options.filterRules);b.filterInputRule(a);n.webkit&&((g=a.lastChild())&&("element"==g.type&&"br"==g.tagName)&&
a.removeChild(g),p.each(b.body.querySelectorAll("div"),function(a){f.isEmptyBlock(a)&&f.remove(a)}));g={html:a.toHtml()};b.fireEvent("beforepaste",g,a);g.html&&(a=UE.htmlparser(g.html,!0),1===b.queryCommandState("pasteplain")?b.execCommand("insertHtml",UE.filterNode(a,b.options.filterTxtRules).toHtml(),!0):(UE.filterNode(a,b.options.filterTxtRules),c=a.toHtml(),d=g.html,e=b.selection.getRange().createAddress(!0),b.execCommand("insertHtml",d,!0)),b.fireEvent("afterpaste",g))}})})})};UE.plugins.list=
function(){function a(a){var b=[],c;for(c in a)b.push(c);return b}function b(a){var b=a.className;return f.hasClass(a,/custom_/)?b.match(/custom_(\w+)/)[1]:f.getStyle(a,"list-style-type")}function c(a,c){p.each(f.getElementsByTagName(a,"ol ul"),function(g){if(f.inDoc(g,a)){var h=g.parentNode;if(h.tagName==g.tagName){var j=b(g)||("OL"==g.tagName?"decimal":"disc"),l=b(h)||("OL"==h.tagName?"decimal":"disc");j==l&&(j=p.indexOf(m[g.tagName],j),j=j+1==m[g.tagName].length?0:j+1,e(g,m[g.tagName][j]))}var r=
0,j=2;if(f.hasClass(g,/custom_/)){if(!/[ou]l/i.test(h.tagName)||!f.hasClass(h,/custom_/))j=1}else/[ou]l/i.test(h.tagName)&&f.hasClass(h,/custom_/)&&(j=3);(h=f.getStyle(g,"list-style-type"))&&(g.style.cssText="list-style-type:"+h);g.className=p.trim(g.className.replace(/list-paddingleft-\w+/,""))+" list-paddingleft-"+j;p.each(f.getElementsByTagName(g,"li"),function(a){a.style.cssText&&(a.style.cssText="");if(a.firstChild){if(a.parentNode===g){r++;if(f.hasClass(g,/custom_/)){var c=1,d=b(g);if("OL"==
g.tagName){if(d)switch(d){case "cn":case "cn1":case "cn2":10<r&&(0==r%10||10<r&&20>r)?c=2:20<r&&(c=3);break;case "num2":9<r&&(c=2)}a.className="list-"+k[d]+r+" list-"+d+"-paddingleft-"+c}else a.className="list-"+k[d]+" list-"+d+"-paddingleft"}else a.className=a.className.replace(/list-[\w\-]+/gi,"");c=a.getAttribute("class");null!==c&&!c.replace(/\s/g,"")&&f.removeAttributes(a,"class")}}else f.remove(a)});!c&&d(g,g.tagName.toLowerCase(),b(g)||f.getStyle(g,"list-style-type"),!0)}})}function d(a,d,
e,g){var h=a.nextSibling;if(h&&1==h.nodeType&&h.tagName.toLowerCase()==d&&(b(h)||f.getStyle(h,"list-style-type")||("ol"==d?"decimal":"disc"))==e)f.moveChild(h,a),0==h.childNodes.length&&f.remove(h);h&&f.isFillChar(h)&&f.remove(h);(h=a.previousSibling)&&(1==h.nodeType&&h.tagName.toLowerCase()==d&&(b(h)||f.getStyle(h,"list-style-type")||("ol"==d?"decimal":"disc"))==e)&&f.moveChild(a,h);h&&f.isFillChar(h)&&f.remove(h);!g&&f.isEmptyBlock(a)&&f.remove(a);b(a)&&c(a.ownerDocument,!0)}function e(a,b){k[b]&&
(a.className="custom_"+b);try{f.setStyle(a,"list-style-type",b)}catch(c){}}function g(a){var b=a.previousSibling;b&&f.isEmptyBlock(b)&&f.remove(b);(b=a.nextSibling)&&f.isEmptyBlock(b)&&f.remove(b)}function h(a){for(;a&&!f.isBody(a);){if("TABLE"==a.nodeName)return null;if("LI"==a.nodeName)return a;a=a.parentNode}}var j=this,l={TD:1,PRE:1,BLOCKQUOTE:1},k={cn:"cn-1-",cn1:"cn-2-",cn2:"cn-3-",num:"num-1-",num1:"num-2-",num2:"num-3-",dash:"dash",dot:"dot"};j.setOpt({insertorderedlist:{num:"",num1:"",num2:"",
cn:"",cn1:"",cn2:"",decimal:"","lower-alpha":"","lower-roman":"","upper-alpha":"","upper-roman":""},insertunorderedlist:{circle:"",disc:"",square:"",dash:"",dot:""},listDefaultPaddingLeft:"30",listiconpath:"http://bs.baidu.com/listicon/",maxListLevel:-1});var m={OL:a(j.options.insertorderedlist),UL:a(j.options.insertunorderedlist)},q=j.options.listiconpath,v;for(v in k)!j.options.insertorderedlist.hasOwnProperty(v)&&!j.options.insertunorderedlist.hasOwnProperty(v)&&delete k[v];j.ready(function(){var a=
...
p.each(a.getNodesByTagName("li"),function(a){for(var b=UE.uNode.createElement("p"),c=0,d;d=a.children[c];)"text"==d.type||t.p[d.tagName]?b.appendChild(d):b.firstChild()?(a.insertBefore(b,d),b=UE.uNode.createElement("p"),c+=2):c++;(b.firstChild()&&!b.parentNode||!a.firstChild())&&a.appendChild(b)});var c={num1:/^\d+\)/,decimal:/^\d+\./,"lower-alpha":/^[a-z]+\)/,"upper-alpha":/^[A-Z]+\./,cn:/^[\u4E00\u4E8C\u4E09\u56DB\u516d\u4e94\u4e03\u516b\u4e5d]+[\u3001]/,cn2:/^\([\u4E00\u4E8C\u4E09\u56DB\u516d\u4e94\u4e03\u516b\u4e5d]+\)/},
d={square:"n"};p.each(a.getNodesByTagName("p"),function(a){if("MsoListParagraph"==a.getAttr("class")){a.setAttr("class","");var d=a,e;if("li"!=a.parentNode.tagName&&(e=b(a.innerText(),a))){var f=UE.uNode.createElement(j.options.insertorderedlist.hasOwnProperty(e)?"ol":"ul");for(k[e]?f.setAttr("class","custom_"+e):f.setStyle("list-style-type",e);a&&"li"!=a.parentNode.tagName&&b(a.innerText(),a);){(d=a.nextSibling())||a.parentNode.insertBefore(f,a);var g=f,h=e;"ol"==g.tagName?a.innerHTML(a.innerHTML().replace(c[h],
"")):a.removeChild(a.firstChild());h=UE.uNode.createElement("li");h.appendChild(a);g.appendChild(h);a=d}!f.parentNode&&(a&&a.parentNode)&&a.parentNode.insertBefore(f,a)}}})});j.addListener("contentchange",function(){c(j.document)});j.addListener("keydown",function(a,b){function c(){b.preventDefault?b.preventDefault():b.returnValue=!1;j.fireEvent("contentchange");j.undoManger&&j.undoManger.save()}function d(a,b){for(;a&&!f.isBody(a)&&!b(a);){if(1==a.nodeType&&/[ou]l/i.test(a.tagName))return a;a=a.parentNode}return null}
var e=b.keyCode||b.which;if(13==e&&!b.shiftKey){var h=j.selection.getRange(),l=f.findParent(h.startContainer,function(a){return f.isBlockElm(a)},!0),k=f.findParentByTagName(h.startContainer,"li",!0);l&&("PRE"!=l.tagName&&!k)&&(k=l.innerHTML.replace(RegExp(f.fillChar,"g"),""),/^\s*1\s*\.[^\d]/.test(k)&&(l.innerHTML=k.replace(/^\s*1\s*\./,""),h.setStartAtLast(l).collapse(!0).select(),j.__hasEnterExecCommand=!0,j.execCommand("insertorderedlist"),j.__hasEnterExecCommand=!1));h=j.selection.getRange();
l=d(h.startContainer,function(a){return"TABLE"==a.tagName});k=h.collapsed?l:d(h.endContainer,function(a){return"TABLE"==a.tagName});if(l&&k&&l===k){if(!h.collapsed)if(l=f.findParentByTagName(h.startContainer,"li",!0),k=f.findParentByTagName(h.endContainer,"li",!0),l&&k&&l===k){if(h.deleteContents(),(k=f.findParentByTagName(h.startContainer,"li",!0))&&f.isEmptyBlock(k)){n=k.previousSibling;next=k.nextSibling;l=j.document.createElement("p");f.fillNode(j.document,l);p=k.parentNode;n&&next?(h.setStart(next,
0).collapse(!0).select(!0),f.remove(k)):(!n&&!next||!n?p.parentNode.insertBefore(l,p):k.parentNode.parentNode.insertBefore(l,p.nextSibling),f.remove(k),p.firstChild||f.remove(p),h.setStart(l,0).setCursor());c();return}}else{var l=h.cloneRange(),m=l.collapse(!1).createBookmark();h.deleteContents();l.moveToBookmark(m);k=f.findParentByTagName(l.startContainer,"li",!0);g(k);l.select();c();return}if(k=f.findParentByTagName(h.startContainer,"li",!0)){if(f.isEmptyBlock(k)){var m=h.createBookmark(),p=k.parentNode;
k!==p.lastChild?(f.breakParent(k,p),g(k)):(p.parentNode.insertBefore(k,p.nextSibling),f.isEmptyNode(p)&&f.remove(p));if(!t.$list[k.parentNode.tagName])if(f.isBlockElm(k.firstChild))f.remove(k,!0);else{l=j.document.createElement("p");for(k.parentNode.insertBefore(l,k);k.firstChild;)l.appendChild(k.firstChild);f.remove(k)}h.moveToBookmark(m).select()}else{l=k.firstChild;if(!l||!f.isBlockElm(l)){l=j.document.createElement("p");for(!k.firstChild&&f.fillNode(j.document,l);k.firstChild;)l.appendChild(k.firstChild);
k.appendChild(l)}m=j.document.createElement("span");h.insertNode(m);f.breakParent(m,k);n=m.nextSibling;l=n.firstChild;l||(l=j.document.createElement("p"),f.fillNode(j.document,l),n.appendChild(l));f.isEmptyNode(l)&&(l.innerHTML="",f.fillNode(j.document,l));h.setStart(l,0).collapse(!0).shrinkBoundary().select();f.remove(m);var n=n.previousSibling;n&&f.isEmptyBlock(n)&&(n.innerHTML="<p></p>",f.fillNode(j.document,n.firstChild))}c()}}}if(8==e&&(h=j.selection.getRange(),h.collapsed&&f.isStartInblock(h)&&
(l=h.cloneRange().trimBoundary(),(k=f.findParentByTagName(h.startContainer,"li",!0))&&f.isStartInblock(l))))if((l=f.findParentByTagName(h.startContainer,"p",!0))&&l!==k.firstChild)p=f.findParentByTagName(l,["ol","ul"]),f.breakParent(l,p),g(l),j.fireEvent("contentchange"),h.setStart(l,0).setCursor(!1,!0),j.fireEvent("saveScene"),f.preventDefault(b);else if(k&&(n=k.previousSibling)){if(!(46==e&&k.childNodes.length)){t.$list[n.tagName]&&(n=n.lastChild);j.undoManger&&j.undoManger.save();l=k.firstChild;
if(f.isBlockElm(l))if(f.isEmptyNode(l)){n.appendChild(l);for(h.setStart(l,0).setCursor(!1,!0);k.firstChild;)n.appendChild(k.firstChild)}else m=j.document.createElement("span"),h.insertNode(m),f.isEmptyBlock(n)&&(n.innerHTML=""),f.moveChild(k,n),h.setStartBefore(m).collapse(!0).select(!0),f.remove(m);else if(f.isEmptyNode(k))l=j.document.createElement("p"),n.appendChild(l),h.setStart(l,0).setCursor();else for(h.setEnd(n,n.childNodes.length).collapse().select(!0);k.firstChild;)n.appendChild(k.firstChild);
f.remove(k);j.fireEvent("contentchange");j.fireEvent("saveScene");f.preventDefault(b)}}else if(k&&!k.previousSibling){p=k.parentNode;m=h.createBookmark();if(f.isTagNode(p.parentNode,"ol ul"))p.parentNode.insertBefore(k,p);else{for(;k.firstChild;)p.parentNode.insertBefore(k.firstChild,p);f.remove(k)}f.isEmptyNode(p)&&f.remove(p);h.moveToBookmark(m).setCursor(!1,!0);j.fireEvent("contentchange");j.fireEvent("saveScene");f.preventDefault(b)}});j.addListener("keyup",function(a,c){if(8==(c.keyCode||c.which)){var e=
...
k=j.document.createElement(l.tagName),n=p.indexOf(m[k.tagName],b(l)||f.getComputedStyle(l,"list-style-type")),n=n+1==m[k.tagName].length?0:n+1,n=m[k.tagName][n];e(k,n);if(f.isStartInblock(c))return j.fireEvent("saveScene"),h=c.createBookmark(),l.insertBefore(k,g),k.appendChild(g),d(k,k.tagName.toLowerCase(),n),j.fireEvent("contentchange"),c.moveToBookmark(h).select(!0),!0}else{j.fireEvent("saveScene");h=c.createBookmark();for(var l=0,q,k=f.findParents(g),C;C=k[l++];)if(f.isTagNode(C,"ol ul")){q=C;
break}C=g;if(h.end)for(;C&&!(f.getPosition(C,h.end)&f.POSITION_FOLLOWING);)if(a(C))C=f.getNextDomNode(C,!1,null,function(a){return a!==q});else{l=C.parentNode;k=j.document.createElement(l.tagName);n=p.indexOf(m[k.tagName],b(l)||f.getComputedStyle(l,"list-style-type"));n=m[k.tagName][n+1==m[k.tagName].length?0:n+1];e(k,n);for(l.insertBefore(k,C);C&&!(f.getPosition(C,h.end)&f.POSITION_FOLLOWING);){g=C.nextSibling;k.appendChild(C);if(!g||f.isTagNode(g,"ol ul")){if(g)for(;(g=g.firstChild)&&"LI"!=g.tagName;);
else g=f.getNextDomNode(C,!1,null,function(a){return a!==q});break}C=g}d(k,k.tagName.toLowerCase(),n);C=g}j.fireEvent("contentchange");c.moveToBookmark(h).select();return!0}}});j.commands.insertorderedlist=j.commands.insertunorderedlist={execCommand:function(a,c){c||(c="insertorderedlist"==a.toLowerCase()?"decimal":"disc");var g=this.selection.getRange(),j=function(a){return 1==a.nodeType?"br"!=a.tagName.toLowerCase():!f.isWhitespace(a)},k="insertorderedlist"==a.toLowerCase()?"ol":"ul",m=this.document.createDocumentFragment();
g.adjustmentBoundary().shrinkBoundary();var n=g.createBookmark(!0),q=h(this.document.getElementById(n.start)),C=0,v=h(this.document.getElementById(n.end)),y=0,z,x,w,u;if(q||v){q&&(z=q.parentNode);n.end||(v=q);v&&(x=v.parentNode);if(z===x){for(;q!==v;){u=q;q=q.nextSibling;if(!f.isBlockElm(u.firstChild)){for(j=this.document.createElement("p");u.firstChild;)j.appendChild(u.firstChild);u.appendChild(j)}m.appendChild(u)}u=this.document.createElement("span");z.insertBefore(u,v);if(!f.isBlockElm(v.firstChild)){for(j=
this.document.createElement("p");v.firstChild;)j.appendChild(v.firstChild);v.appendChild(j)}m.appendChild(v);f.breakParent(u,z);f.isEmptyNode(u.previousSibling)&&f.remove(u.previousSibling);f.isEmptyNode(u.nextSibling)&&f.remove(u.nextSibling);j=b(z)||f.getComputedStyle(z,"list-style-type")||("insertorderedlist"==a.toLowerCase()?"decimal":"disc");if(z.tagName.toLowerCase()==k&&j==c){for(var j=0,F=this.document.createDocumentFragment();v=m.childNodes[j++];)if(f.isTagNode(v,"ol ul"))p.each(f.getElementsByTagName(v,
"li"),function(a){for(;a.firstChild;)F.appendChild(a.firstChild)});else for(;v.firstChild;)F.appendChild(v.firstChild);u.parentNode.insertBefore(F,u)}else w=this.document.createElement(k),e(w,c),w.appendChild(m),u.parentNode.insertBefore(w,u);f.remove(u);w&&d(w,k,c);g.moveToBookmark(n).select();return}if(q){for(;q;){u=q.nextSibling;if(f.isTagNode(q,"ol ul"))m.appendChild(q);else{w=this.document.createDocumentFragment();for(var B=0;q.firstChild;)f.isBlockElm(q.firstChild)&&(B=1),w.appendChild(q.firstChild);
B?m.appendChild(w):(B=this.document.createElement("p"),B.appendChild(w),m.appendChild(B));f.remove(q)}q=u}z.parentNode.insertBefore(m,z.nextSibling);f.isEmptyNode(z)?(g.setStartBefore(z),f.remove(z)):g.setStartAfter(z);C=1}if(v&&f.inDoc(x,this.document)){for(q=x.firstChild;q&&q!==v;){u=q.nextSibling;if(f.isTagNode(q,"ol ul"))m.appendChild(q);else{w=this.document.createDocumentFragment();for(B=0;q.firstChild;)f.isBlockElm(q.firstChild)&&(B=1),w.appendChild(q.firstChild);B?m.appendChild(w):(B=this.document.createElement("p"),
B.appendChild(w),m.appendChild(B));f.remove(q)}q=u}u=f.createElement(this.document,"div",{tmpDiv:1});f.moveChild(v,u);m.appendChild(u);f.remove(v);x.parentNode.insertBefore(m,x);g.setEndBefore(x);f.isEmptyNode(x)&&f.remove(x);y=1}}C||g.setStartBefore(this.document.getElementById(n.start));n.end&&!y&&g.setEndAfter(this.document.getElementById(n.end));g.enlarge(!0,function(a){return l[a.tagName]});m=this.document.createDocumentFragment();v=g.createBookmark();z=f.getNextDomNode(v.start,!1,j);q=g.cloneRange();
for(x=f.isBlockElm;z&&z!==v.end&&f.getPosition(z,v.end)&f.POSITION_PRECEDING;)if(3==z.nodeType||t.li[z.tagName])if(1==z.nodeType&&t.$list[z.tagName]){for(;z.firstChild;)m.appendChild(z.firstChild);C=f.getNextDomNode(z,!1,j);f.remove(z);z=C}else{C=z;for(q.setStartBefore(z);z&&z!==v.end&&(!x(z)||f.isBookmarkNode(z));)C=z,z=f.getNextDomNode(z,!1,null,function(a){return!l[a.tagName]});if(z&&x(z)&&(u=f.getNextDomNode(C,!1,j))&&f.isBookmarkNode(u))z=f.getNextDomNode(u,!1,j),C=u;q.setEndAfter(C);z=f.getNextDomNode(C,
!1,j);u=g.document.createElement("li");u.appendChild(q.extractContents());if(f.isEmptyNode(u)){for(C=g.document.createElement("p");u.firstChild;)C.appendChild(u.firstChild);u.appendChild(C)}m.appendChild(u)}else z=f.getNextDomNode(z,!0,j);g.moveToBookmark(v).collapse(!0);w=this.document.createElement(k);e(w,c);w.appendChild(m);g.insertNode(w);d(w,k,c);j=0;for(k=f.getElementsByTagName(w,"div");v=k[j++];)v.getAttribute("tmpDiv")&&f.remove(v,!0);g.moveToBookmark(n).select()},queryCommandState:function(a){a=
"insertorderedlist"==a.toLowerCase()?"ol":"ul";for(var b=this.selection.getStartElementPath(),c=0,d;(d=b[c++])&&"TABLE"!=d.nodeName;)if(a==d.nodeName.toLowerCase())return 1;return 0},queryCommandValue:function(a){a="insertorderedlist"==a.toLowerCase()?"ol":"ul";for(var c=this.selection.getStartElementPath(),d,e=0,g;g=c[e++];){if("TABLE"==g.nodeName){d=null;break}if(a==g.nodeName.toLowerCase()){d=g;break}}return d?b(d)||f.getComputedStyle(d,"list-style-type"):null}}};var Nc={textarea:function(a,b){var c=
b.ownerDocument.createElement("textarea");c.style.cssText="position:absolute;resize:none;width:100%;height:100%;border:0;padding:0;margin:0;overflow-y:auto;";n.ie&&8>n.version&&(c.style.width=b.offsetWidth+"px",c.style.height=b.offsetHeight+"px",b.onresize=function(){c.style.width=b.offsetWidth+"px";c.style.height=b.offsetHeight+"px"});b.appendChild(c);return{setContent:function(a){c.value=a},getContent:function(){return c.value},select:function(){var a;n.ie?(a=c.createTextRange(),a.collapse(!0),
a.select()):(c.setSelectionRange(0,0),c.focus())},dispose:function(){b.removeChild(c);b=c=b.onresize=null}}},codemirror:function(a,b){var c=window.CodeMirror(b,{mode:"text/html",tabMode:"indent",lineNumbers:!0,lineWrapping:!0}),d=c.getWrapperElement();d.style.cssText='position:absolute;left:0;top:0;width:100%;height:100%;font-family:consolas,"Courier new",monospace;font-size:13px;';c.getScrollerElement().style.cssText="position:absolute;left:0;top:0;width:100%;height:100%;";c.refresh();return{getCodeMirror:function(){return c},
setContent:function(a){c.setValue(a)},getContent:function(){return c.getValue()},select:function(){c.focus()},dispose:function(){b.removeChild(d);c=d=null}}}};UE.plugins.source=function(){var a=this,b=this.options,c=!1,d;b.sourceEditor=n.ie?"textarea":b.sourceEditor||"codemirror";a.setOpt({sourceEditorFirst:!1});var e,g=a.getContent,h;a.commands.source={execCommand:function(){if(c=!c){h=a.selection.getRange().createAddress(!1,!0);a.undoManger&&a.undoManger.save(!0);n.gecko&&(a.body.contentEditable=
!1);e=a.iframe.style.cssText;a.iframe.style.cssText+="position:absolute;left:-32768px;top:-32768px;";a.fireEvent("beforegetcontent");var j=UE.htmlparser(a.body.innerHTML,!0);a.filterOutputRule(j);j.traversal(function(a){if("element"==a.type)switch(a.tagName){case "td":case "th":case "caption":a.children&&1==a.children.length&&"br"==a.firstChild().tagName&&a.removeChild(a.firstChild());break;case "pre":a.innerText(a.innerText().replace(/&nbsp;/g," "))}});a.fireEvent("aftergetcontent");j=j.toHtml(!0);
d=Nc["codemirror"==b.sourceEditor&&window.CodeMirror?"codemirror":"textarea"](a,a.iframe.parentNode);d.setContent(j);setTimeout(function(){d.select();a.addListener("fullscreenchanged",function(){try{d.getCodeMirror().refresh()}catch(a){}})});a.getContent=function(){return d.getContent()||"<p>"+(n.ie?"":"<br/>")+"</p>"}}else if(a.iframe.style.cssText=e,j=d.getContent()||"<p>"+(n.ie?"":"<br/>")+"</p>",a.setContent(j),d.dispose(),d=null,a.getContent=g,j=a.body.firstChild,j||(a.body.innerHTML="<p>"+(n.ie?
"":"<br/>")+"</p>",j=a.body.firstChild),a.undoManger&&a.undoManger.save(!0),n.gecko){var k=document.createElement("input");k.style.cssText="position:absolute;left:0;top:-32768px";document.body.appendChild(k);a.body.contentEditable=!1;setTimeout(function(){f.setViewportOffset(k,{left:-32768,top:0});k.focus();setTimeout(function(){a.body.contentEditable=!0;a.selection.getRange().moveToAddress(h).select(!0);f.remove(k)})})}else try{a.selection.getRange().moveToAddress(h).select(!0)}catch(m){}this.fireEvent("sourcemodechanged",
c)},queryCommandState:function(){return c|0},notNeedUndo:1};var j=a.queryCommandState;a.queryCommandState=function(a){a=a.toLowerCase();return c?a in{source:1,fullscreen:1}?1:-1:j.apply(this,arguments)};"codemirror"==b.sourceEditor&&a.addListener("ready",function(){p.loadFile(document,{src:b.codeMirrorJsUrl||b.UEDITOR_HOME_URL+"third-party/codemirror/codemirror.js",tag:"script",type:"text/javascript",defer:"defer"},function(){b.sourceEditorFirst&&setTimeout(function(){a.execCommand("source")},0)});
...
f.fillChar),""),g.startOffset--,g.collapse(!0).select(!0)));if(j=g.getClosedNode()){a.fireEvent("saveScene");g.setStartBefore(j);f.remove(j);g.setCursor();a.fireEvent("saveScene");f.preventDefault(d);return}if(!n.ie&&(j=f.findParentByTagName(g.startContainer,"table",!0),l=f.findParentByTagName(g.endContainer,"table",!0),j&&!l||!j&&l||j!==l)){d.preventDefault();return}}if(9==e){var k={ol:1,ul:1,table:1};if(a.fireEvent("tabkeydown",d)){f.preventDefault(d);return}g=a.selection.getRange();a.fireEvent("saveScene");
h=0;j="";l=a.options.tabSize||4;for(var m=a.options.tabNode||"&nbsp;";h<l;h++)j+=m;h=a.document.createElement("span");h.innerHTML=j+f.fillChar;if(g.collapsed)g.insertNode(h.cloneNode(!0).firstChild).setCursor(!0);else if(j=f.findParent(g.startContainer,p),l=f.findParent(g.endContainer,p),j&&l&&j===l)g.deleteContents(),g.insertNode(h.cloneNode(!0).firstChild).setCursor(!0);else{j=g.createBookmark();var p=function(a){return f.isBlockElm(a)&&!k[a.tagName.toLowerCase()]};g.enlarge(!0);l=g.createBookmark();
for(m=f.getNextDomNode(l.start,!1,p);m&&!(f.getPosition(m,l.end)&f.POSITION_FOLLOWING);)m.insertBefore(h.cloneNode(!0).firstChild,m.firstChild),m=f.getNextDomNode(m,!1,p);g.moveToBookmark(l).moveToBookmark(j).select()}f.preventDefault(d)}if(n.gecko&&46==e&&(g=a.selection.getRange(),g.collapsed&&(j=g.startContainer,f.isEmptyBlock(j)))){for(e=j.parentNode;1==f.getChildCount(e)&&!f.isBody(e);)j=e,e=e.parentNode;j===e.lastChild&&d.preventDefault()}});a.addListener("keyup",function(a,d){var e;if(8==(d.keyCode||
d.which)&&!this.fireEvent("delkeyup")){e=this.selection.getRange();if(e.collapsed){var g;if((g=f.findParentByTagName(e.startContainer,"h1 h2 h3 h4 h5 h6".split(" "),!0))&&f.isEmptyBlock(g)){var h=g.previousSibling;if(h&&"TABLE"!=h.nodeName){f.remove(g);e.setStartAtLast(h).setCursor(!1,!0);return}if((h=g.nextSibling)&&"TABLE"!=h.nodeName){f.remove(g);e.setStartAtFirst(h).setCursor(!1,!0);return}}f.isBody(e.startContainer)&&(g=f.createElement(this.document,"p",{innerHTML:n.ie?f.fillChar:"<br/>"}),e.insertNode(g).setStart(g,
0).setCursor(!1,!0))}if(!b&&(3==e.startContainer.nodeType||1==e.startContainer.nodeType&&f.isEmptyBlock(e.startContainer)))n.ie?(g=e.document.createElement("span"),e.insertNode(g).setStartBefore(g).collapse(!0),e.select(),f.remove(g)):e.select()}})};UE.plugins.fiximgclick=function(){var a=this;n.webkit&&a.addListener("click",function(b,c){"IMG"==c.target.tagName&&(new R.Range(a.document)).selectNode(c.target).select()})};UE.plugins.autolink=function(){if(!n.ie){var a=this;a.addListener("reset",function(){});
a.addListener("keydown",function(b,c){var d=c.keyCode||c.which;if(32==d||13==d){for(var d=a.selection.getNative(),e=d.getRangeAt(0).cloneRange(),g,h=e.startContainer;1==h.nodeType&&0<e.startOffset;){h=e.startContainer.childNodes[e.startOffset-1];if(!h)break;e.setStart(h,1==h.nodeType?h.childNodes.length:h.nodeValue.length);e.collapse(!0);h=e.startContainer}do{if(0==e.startOffset){for(h=e.startContainer.previousSibling;h&&1==h.nodeType;)h=h.lastChild;if(!h||f.isFillChar(h))break;g=h.nodeValue.length}else h=
e.startContainer,g=e.startOffset;e.setStart(h,g-1);g=e.toString().charCodeAt(0)}while(160!=g&&32!=g);if(e.toString().replace(RegExp(f.fillChar,"g"),"").match(/(?:https?:\/\/|ssh:\/\/|ftp:\/\/|file:\/|www\.)/i)){for(;e.toString().length&&!/^(?:https?:\/\/|ssh:\/\/|ftp:\/\/|file:\/|www\.)/i.test(e.toString());)try{e.setStart(e.startContainer,e.startOffset+1)}catch(j){for(h=e.startContainer;!(next=h.nextSibling);){if(f.isBody(h))return;h=h.parentNode}e.setStart(next,0)}if(!f.findParentByTagName(e.startContainer,
"a",!0)){g=a.document.createElement("a");var h=a.document.createTextNode(" "),l;a.undoManger&&a.undoManger.save();g.appendChild(e.extractContents());g.href=g.innerHTML=g.innerHTML.replace(/<[^>]+>/g,"");l=g.getAttribute("href").replace(RegExp(f.fillChar,"g"),"");l=/^(?:https?:\/\/)/ig.test(l)?l:"http://"+l;g.setAttribute("_src",p.html(l));g.href=p.html(l);e.insertNode(g);g.parentNode.insertBefore(h,g.nextSibling);e.setStart(h,0);e.collapse(!0);d.removeAllRanges();d.addRange(e);a.undoManger&&a.undoManger.save()}}}})}};
UE.plugins.autoheight=function(){function a(){var a=this;clearTimeout(l);k||(l=setTimeout(function(){a.queryCommandState&&1!=a.queryCommandState("source")&&(d||(d=a.document.createElement("span"),d.style.cssText="display:block;width:0;margin:0;padding:0;border:0;clear:both;",d.innerHTML="."),e=d.cloneNode(!0),a.body.appendChild(e),j=Math.max(f.getXY(e).y+e.offsetHeight,Math.max(h.minFrameHeight,h.initialFrameHeight)),j!=g&&(a.setHeight(j),g=j),f.remove(e))},50))}var b=this;b.autoHeightEnabled=!1!==
b.options.autoHeightEnabled;if(b.autoHeightEnabled){var c,d,e,g=0,h=b.options,j,l,k;b.addListener("fullscreenchanged",function(a,b){k=b});b.addListener("destroy",function(){b.removeListener("contentchange",a);b.removeListener("afterinserthtml",a);b.removeListener("keyup",a);b.removeListener("mouseup",a)});b.enableAutoHeight=function(){if(b.autoHeightEnabled){var d=b.document;b.autoHeightEnabled=!0;c=d.body.style.overflowY;d.body.style.overflowY="hidden";b.addListener("contentchange",a);b.addListener("afterinserthtml",
a);b.addListener("keyup",a);b.addListener("mouseup",a);setTimeout(function(){a.call(this)},n.gecko?100:0);b.fireEvent("autoheightchanged",b.autoHeightEnabled)}};b.disableAutoHeight=function(){b.body.style.overflowY=c||"";b.removeListener("contentchange",a);b.removeListener("keyup",a);b.removeListener("mouseup",a);b.autoHeightEnabled=!1;b.fireEvent("autoheightchanged",b.autoHeightEnabled)};b.addListener("ready",function(){b.enableAutoHeight();var c;f.on(n.ie?b.body:b.document,n.webkit?"dragover":"drop",
function(){clearTimeout(c);c=setTimeout(function(){a.call(this)},100)})})}};UE.plugins.autofloat=function(){function a(){t=!0;k.parentNode&&k.parentNode.removeChild(k);m.style.cssText=l}function b(){var b=v(c.container),d=c.options.toolbarTopOffset||0;if(0>b.top&&b.bottom-m.offsetHeight>d){var b=f.getXY(m),d=f.getComputedStyle(m,"position"),g=f.getComputedStyle(m,"left");m.style.width=m.offsetWidth+"px";m.style.zIndex=1*c.options.zIndex+1;m.parentNode.insertBefore(k,m);h||j&&n.ie?("absolute"!=m.style.position&&
(m.style.position="absolute"),m.style.top=(document.body.scrollTop||document.documentElement.scrollTop)-q+e+"px"):(n.ie7Compat&&t&&(t=!1,m.style.left=f.getXY(m).x-document.documentElement.getBoundingClientRect().left+2+"px"),"fixed"!=m.style.position&&(m.style.position="fixed",m.style.top=e+"px",("absolute"==d||"relative"==d)&&parseFloat(g)&&(m.style.left=b.x+"px")))}else a()}var c=this,d=c.getLang();c.setOpt({topOffset:0});var e=c.options.topOffset;if(!1!==c.options.autoFloatEnabled){var g=UE.ui.uiUtils,
h=n.ie&&6>=n.version,j=n.quirks,l,k=document.createElement("div"),m,q,v,t=!0,s=p.defer(function(){b()},n.ie?200:100,!0);c.addListener("destroy",function(){f.un(window,["scroll","resize"],b);c.removeListener("keydown",s)});c.addListener("ready",function(){var e;c.ui?e=1:(alert(d.autofloatMsg),e=0);e&&(v=g.getClientRect,m=c.ui.getDom("toolbarbox"),q=v(m).top,l=m.style.cssText,k.style.height=m.offsetHeight+"px",h&&(e=document.body.style,e.backgroundImage='url("about:blank")',e.backgroundAttachment="fixed"),
f.on(window,["scroll","resize"],b),c.addListener("keydown",s),c.addListener("beforefullscreenchange",function(b,c){c&&a()}),c.addListener("fullscreenchanged",function(a,c){c||b()}),c.addListener("sourcemodechanged",function(){setTimeout(function(){b()},0)}),c.addListener("clearDoc",function(){setTimeout(function(){b()},0)}))})}};UE.plugins.pasteplain=function(){this.setOpt({pasteplain:!1,filterTxtRules:function(){function a(b){b.tagName="p";b.setStyle()}return{"-":"script style object iframe embed input select",
p:{$:{}},br:{$:{}},div:function(a){for(var b,e=UE.uNode.createElement("p");b=a.firstChild();)"text"==b.type||!UE.dom.dtd.$block[b.tagName]?e.appendChild(b):e.firstChild()?(a.parentNode.insertBefore(e,a),e=UE.uNode.createElement("p")):a.parentNode.insertBefore(b,a);e.firstChild()&&a.parentNode.insertBefore(e,a);a.parentNode.removeChild(a)},ol:function(a){a.parentNode.removeChild(a,!0)},ul:function(a){a.parentNode.removeChild(a,!0)},dl:function(a){a.parentNode.removeChild(a,!0)},dt:function(a){a.parentNode.removeChild(a,
!0)},dd:function(a){a.parentNode.removeChild(a,!0)},li:function(a){a.parentNode.removeChild(a,!0)},caption:a,th:a,tr:a,h1:a,h2:a,h3:a,h4:a,h5:a,h6:a,td:function(a){a.innerText()&&a.parentNode.insertAfter(UE.uNode.createText(" &nbsp; &nbsp;"),a);a.parentNode.removeChild(a,a.innerText())}}}()});var a=this.options.pasteplain;this.commands.pasteplain={queryCommandState:function(){return a?1:0},execCommand:function(){a=!a|0},notNeedUndo:1}};UE.plugins.video=function(){function a(a,b,f,h,j,l){return!l?
...
a.className?1:0}}};var G=UE.UETable=function(a){this.table=a;this.indexTable=[];this.selectedTds=[];this.cellsRange={};this.update(a)};G.removeSelectedClass=function(a){p.each(a,function(a){f.removeClasses(a,"selectTdClass")})};G.addSelectedClass=function(a){p.each(a,function(a){f.addClass(a,"selectTdClass")})};G.isEmptyBlock=function(a){var b=RegExp(f.fillChar,"g");if(0<a[n.ie?"innerText":"textContent"].replace(/^\s*$/,"").replace(b,"").length)return 0;for(var c in t.$isNotEmpty)if(t.$isNotEmpty.hasOwnProperty(c)&&
...
"noBorderTable"))}function B(a,b,c){var d=a.body;return d.offsetWidth-(b?2*parseInt(f.getComputedStyle(d,"margin-left"),10):0)-2*c.tableBorder-(a.options.offsetWidth||0)}function Hb(a,b){var c=f.findParentByTagName(b.target||b.srcElement,["td","th"],!0);return c&&!0!==a.fireEvent("excludetable",c)?c:null}var r=this,F=!0,M=UE.UETable,D=function(a){return M.getUETable(a)},H=function(a){return M.removeSelectedClass(a)};r.ready(function(){var a=this,b=a.selection.getText;a.selection.getText=function(){var c=
...
return a&&"edui-faked-music"==a.className?1:0}}};q=q||{};q.editor=q.editor||{};q.editor.ui={};var La=function(){var a=document.getElementById("edui_fixedlayer");Y.setViewportOffset(a,{left:0,top:0})},V=q.editor.browser,ba=q.editor.dom.domUtils,Kb=window.$EDITORUI={},Lb=0,Y=q.editor.ui.uiUtils={uid:function(a){return a?a.ID$EDITORUI||(a.ID$EDITORUI=++Lb):++Lb},hook:function(a,b){var c;a&&a._callbacks?c=a:(c=function(){var b;a&&(b=a.apply(this,arguments));for(var e=c._callbacks,f=e.length;f--;){var h=
e[f].apply(this,arguments);void 0===b&&(b=h)}return b},c._callbacks=[]);c._callbacks.push(b);return c},createElementByHtml:function(a){var b=document.createElement("div");b.innerHTML=a;b=b.firstChild;b.parentNode.removeChild(b);return b},getViewportElement:function(){return V.ie&&V.quirks?document.body:document.documentElement},getClientRect:function(a){var b;try{b=a.getBoundingClientRect()}catch(c){b={left:0,top:0,height:0,width:0}}for(var d={left:Math.round(b.left),top:Math.round(b.top),height:Math.round(b.bottom-
b.top),width:Math.round(b.right-b.left)},e;(e=a.ownerDocument)!==document&&(a=ba.getWindow(e).frameElement);)b=a.getBoundingClientRect(),d.left+=b.left,d.top+=b.top;d.bottom=d.top+d.height;d.right=d.left+d.width;return d},getViewportRect:function(){var a=Y.getViewportElement(),b=(window.innerWidth||a.clientWidth)|0,a=(window.innerHeight||a.clientHeight)|0;return{left:0,top:0,height:a,width:b,bottom:a,right:b}},setViewportOffset:function(a,b){var c=Y.getFixedLayer();a.parentNode===c?(a.style.left=
b.left+"px",a.style.top=b.top+"px"):ba.setViewportOffset(a,b)},getEventOffset:function(a){var b=Y.getClientRect(a.target||a.srcElement);a=Y.getViewportOffsetByEvent(a);return{left:a.left-b.left,top:a.top-b.top}},getViewportOffsetByEvent:function(a){var b=a.target||a.srcElement,c=ba.getWindow(b).frameElement;a={left:a.clientX,top:a.clientY};c&&b.ownerDocument!==document&&(b=Y.getClientRect(c),a.left+=b.left,a.top+=b.top);return a},setGlobal:function(a,b){Kb[a]=b;return'$EDITORUI["'+a+'"]'},unsetGlobal:function(a){delete Kb[a]},
...
a.compareDocumentPosition(b)&16)},startDrag:function(a,b,c){function d(a){b.ondragmove(a.clientX-e,a.clientY-f,a);a.stopPropagation?a.stopPropagation():a.cancelBubble=!0}c=c||document;var e=a.clientX,f=a.clientY;if(c.addEventListener){var h=function(){c.removeEventListener("mousemove",d,!0);c.removeEventListener("mouseup",h,!0);window.removeEventListener("mouseup",h,!0);b.ondragstop()};c.addEventListener("mousemove",d,!0);c.addEventListener("mouseup",h,!0);window.addEventListener("mouseup",h,!0);
a.preventDefault()}else{var j=a.srcElement;j.setCapture();var l=function(){j.releaseCapture();j.detachEvent("onmousemove",d);j.detachEvent("onmouseup",l);j.detachEvent("onlosecaptrue",l);b.ondragstop()};j.attachEvent("onmousemove",d);j.attachEvent("onmouseup",l);j.attachEvent("onlosecaptrue",l);a.returnValue=!1}b.ondragstart()},getFixedLayer:function(){var a=document.getElementById("edui_fixedlayer");null==a&&(a=document.createElement("div"),a.id="edui_fixedlayer",document.body.appendChild(a),V.ie&&
8>=V.version?(a.style.position="absolute",ba.on(window,"scroll",La),ba.on(window,"resize",q.editor.utils.defer(La,0,!0)),setTimeout(La)):a.style.position="fixed",a.style.left="0",a.style.top="0",a.style.width="0",a.style.height="0");return a},makeUnselectable:function(a){if(V.opera||V.ie&&9>V.version){if(a.unselectable="on",a.hasChildNodes())for(var b=0;b<a.childNodes.length;b++)1==a.childNodes[b].nodeType&&Y.makeUnselectable(a.childNodes[b])}else void 0!==a.style.MozUserSelect?a.style.MozUserSelect=
"none":void 0!==a.style.WebkitUserSelect?a.style.WebkitUserSelect="none":void 0!==a.style.KhtmlUserSelect&&(a.style.KhtmlUserSelect="none")}},Mb=q.editor.utils,ca=q.editor.ui.uiUtils,Pc=q.editor.EventBase,Nb=q.editor.ui.UIBase=function(){};Nb.prototype={className:"",uiName:"",initOptions:function(a){for(var b in a)this[b]=a[b];this.id=this.id||"edui"+ca.uid()},initUIBase:function(){this._globalKey=Mb.unhtml(ca.setGlobal(this.id,this))},render:function(a){for(var b=this.renderHtml(),b=ca.createElementByHtml(b),
c=f.getElementsByTagName(b,"*"),d="edui-"+(this.theme||this.editor.options.theme),e=document.getElementById("edui_fixedlayer"),g=0,h;h=c[g++];)f.addClass(h,d);f.addClass(b,d);e&&(e.className="",f.addClass(e,d));c=this.getDom();null!=c?(c.parentNode.replaceChild(b,c),ca.copyAttributes(b,c)):("string"==typeof a&&(a=document.getElementById(a)),a=a||ca.getFixedLayer(),f.addClass(a,d),a.appendChild(b));this.postRender()},getDom:function(a){return a?document.getElementById(this.id+"_"+a):document.getElementById(this.id)},
postRender:function(){this.fireEvent("postrender")},getHtmlTpl:function(){return""},formatHtml:function(a){var b="edui-"+this.uiName;return a.replace(/##/g,this.id).replace(/%%-/g,this.uiName?b+"-":"").replace(/%%/g,(this.uiName?b:"")+" "+this.className).replace(/\$\$/g,this._globalKey)},renderHtml:function(){return this.formatHtml(this.getHtmlTpl())},dispose:function(){var a=this.getDom();a&&q.editor.dom.domUtils.remove(a);ca.unsetGlobal(this.id)}};Mb.inherits(Nb,Pc);var Qc=q.editor.utils,Rc=q.editor.ui.UIBase,
Ob=q.editor.ui.Separator=function(a){this.initOptions(a);this.initSeparator()};Ob.prototype={uiName:"separator",initSeparator:function(){this.initUIBase()},getHtmlTpl:function(){return'<div id="##" class="edui-box %%"></div>'}};Qc.inherits(Ob,Rc);var Sc=q.editor.utils,Tc=q.editor.dom.domUtils,Uc=q.editor.ui.UIBase,Vc=q.editor.ui.uiUtils,Pb=q.editor.ui.Mask=function(a){this.initOptions(a);this.initUIBase()};Pb.prototype={getHtmlTpl:function(){return'<div id="##" class="edui-mask %%" onmousedown="return $$._onMouseDown(event, this);"></div>'},
postRender:function(){var a=this;Tc.on(window,"resize",function(){setTimeout(function(){a.isHidden()||a._fill()})})},show:function(a){this._fill();this.getDom().style.display="";this.getDom().style.zIndex=a},hide:function(){this.getDom().style.display="none";this.getDom().style.zIndex=""},isHidden:function(){return"none"==this.getDom().style.display},_onMouseDown:function(){return!1},_fill:function(){var a=this.getDom(),b=Vc.getViewportRect();a.style.width=b.width+"px";a.style.height=b.height+"px"}};
Sc.inherits(Pb,Uc);var Na=function(a,b){for(var c=0;c<Ma.length;c++){var d=Ma[c];if(!d.isHidden()&&!1!==d.queryAutoHide(b)){if(a&&/scroll/ig.test(a.type)&&"edui-wordpastepop"==d.className)break;d.hide()}}},Wc=q.editor.utils,ia=q.editor.ui.uiUtils,Oa=q.editor.dom.domUtils,Pa=q.editor.ui.UIBase,Qa=q.editor.ui.Popup=function(a){this.initOptions(a);this.initPopup()},Ma=[];Qa.postHide=Na;var Qb=["edui-anchor-topleft","edui-anchor-topright","edui-anchor-bottomleft","edui-anchor-bottomright"];Qa.prototype=
{SHADOW_RADIUS:5,content:null,_hidden:!1,autoRender:!0,canSideLeft:!0,canSideUp:!0,initPopup:function(){this.initUIBase();Ma.push(this)},getHtmlTpl:function(){return'<div id="##" class="edui-popup %%"> <div id="##_body" class="edui-popup-body"> <iframe style="position:absolute;z-index:-1;left:0;top:0;background-color: transparent;" frameborder="0" width="100%" height="100%" src="javascript:"></iframe> <div class="edui-shadow"></div> <div id="##_content" class="edui-popup-content">'+this.getContentHtmlTpl()+
"  </div> </div></div>"},getContentHtmlTpl:function(){return this.content?"string"==typeof this.content?this.content:this.content.renderHtml():""},_UIBase_postRender:Pa.prototype.postRender,postRender:function(){this.content instanceof Pa&&this.content.postRender();this.fireEvent("postRenderAfter");this.hide(!0);this._UIBase_postRender()},_doAutoRender:function(){!this.getDom()&&this.autoRender&&this.render()},mesureSize:function(){var a=this.getDom("content");return ia.getClientRect(a)},fitSize:function(){var a=
...
a.top):(e=this.canSideLeft&&a.right+d.width>c.right&&a.left>d.width,c=this.canSideUp&&a.top+d.height>c.bottom&&a.bottom>d.height,f=e?a.right-d.width:a.left,d=c?a.top-d.height:a.bottom);var h=this.getDom();ia.setViewportOffset(h,{left:f,top:d});Oa.removeClasses(h,Qb);h.className+=" "+Qb[2*(c?1:0)+(e?1:0)];this.editor&&(h.style.zIndex=1*this.editor.container.style.zIndex+10,q.editor.ui.uiUtils.getFixedLayer().style.zIndex=h.style.zIndex-1)},showAt:function(a){var b=a.left;a=a.top;this.showAnchorRect({left:b,
top:a,right:b,bottom:a,height:0,width:0},!1,!0)},_show:function(){this._hidden&&(this.getDom().style.display="",this._hidden=!1,this.fireEvent("show"))},isHidden:function(){return this._hidden},show:function(){this._doAutoRender();this._show()},hide:function(a){!this._hidden&&this.getDom()&&(this.getDom().style.display="none",this._hidden=!0,a||this.fireEvent("hide"))},queryAutoHide:function(a){return!a||!ia.contains(this.getDom(),a)}};Wc.inherits(Qa,Pa);Oa.on(document,"mousedown",function(a){Na(a,
a.target||a.srcElement)});Oa.on(window,"scroll",function(a,b){Na(a,b)});var Xc=q.editor.utils,Yc=q.editor.ui.UIBase,Rb=q.editor.ui.ColorPicker=function(a){this.initOptions(a);this.noColorText=this.noColorText||this.editor.getLang("clearColor");this.initUIBase()};Rb.prototype={getHtmlTpl:function(){for(var a=this.editor,b='<div id="##" class="edui-colorpicker %%"><div class="edui-colorpicker-topbar edui-clearfix"><div unselectable="on" id="##_preview" class="edui-colorpicker-preview"></div><div unselectable="on" class="edui-colorpicker-nocolor" onclick="$$._onPickNoColor(event, this);">'+
this.noColorText+'</div></div><table  class="edui-box" style="border-collapse: collapse;" onmouseover="$$._onTableOver(event, this);" onmouseout="$$._onTableOut(event, this);" onclick="return $$._onTableClick(event, this);" cellspacing="0" cellpadding="0"><tr style="border-bottom: 1px solid #ddd;font-size: 13px;line-height: 25px;color:#39C;padding-top: 2px"><td colspan="10">'+a.getLang("themeColor")+'</td> </tr><tr class="edui-colorpicker-tablefirstrow" >',c=0;c<va.length;c++)c&&0===c%10&&(b+="</tr>"+
(60==c?'<tr style="border-bottom: 1px solid #ddd;font-size: 13px;line-height: 25px;color:#39C;"><td colspan="10">'+a.getLang("standardColor")+"</td></tr>":"")+"<tr"+(60==c?' class="edui-colorpicker-tablefirstrow"':"")+">"),b+=70>c?'<td style="padding: 0 2px;"><a hidefocus title="'+va[c]+'" onclick="return false;" href="javascript:" unselectable="on" class="edui-box edui-colorpicker-colorcell" data-color="#'+va[c]+'" style="background-color:#'+va[c]+";border:solid #ccc;"+(10>c||60<=c?"border-width:1px;":
10<=c&&20>c?"border-width:1px 1px 0 1px;":"border-width:0 1px 0 1px;")+'"></a></td>':"";return b+"</tr></table></div>"},_onTableClick:function(a){(a=(a.target||a.srcElement).getAttribute("data-color"))&&this.fireEvent("pickcolor",a)},_onTableOver:function(a){if(a=(a.target||a.srcElement).getAttribute("data-color"))this.getDom("preview").style.backgroundColor=a},_onTableOut:function(){this.getDom("preview").style.backgroundColor=""},_onPickNoColor:function(){this.fireEvent("picknocolor")}};Xc.inherits(Rb,
Yc);var va="ffffff 000000 eeece1 1f497d 4f81bd c0504d 9bbb59 8064a2 4bacc6 f79646 f2f2f2 7f7f7f ddd9c3 c6d9f0 dbe5f1 f2dcdb ebf1dd e5e0ec dbeef3 fdeada d8d8d8 595959 c4bd97 8db3e2 b8cce4 e5b9b7 d7e3bc ccc1d9 b7dde8 fbd5b5 bfbfbf 3f3f3f 938953 548dd4 95b3d7 d99694 c3d69b b2a2c7 92cddc fac08f a5a5a5 262626 494429 17365d 366092 953734 76923c 5f497a 31859b e36c09 7f7f7f 0c0c0c 1d1b10 0f243e 244061 632423 4f6128 3f3151 205867 974806 c00000 ff0000 ffc000 ffff00 92d050 00b050 00b0f0 0070c0 002060 7030a0 ".split(" "),
Zc=q.editor.utils,Ra=q.editor.ui.uiUtils,Sb=q.editor.ui.UIBase,Tb=q.editor.ui.TablePicker=function(a){this.initOptions(a);this.initTablePicker()};Tb.prototype={defaultNumRows:10,defaultNumCols:10,maxNumRows:20,maxNumCols:20,numRows:10,numCols:10,lengthOfCellSide:22,initTablePicker:function(){this.initUIBase()},getHtmlTpl:function(){return'<div id="##" class="edui-tablepicker %%"><div class="edui-tablepicker-body"><div class="edui-infoarea"><span id="##_label" class="edui-label"></span></div><div class="edui-pickarea" onmousemove="$$._onMouseMove(event, this);" onmouseover="$$._onMouseOver(event, this);" onmouseout="$$._onMouseOut(event, this);" onclick="$$._onClick(event, this);"><div id="##_overlay" class="edui-overlay"></div></div></div></div>'},
_UIBase_render:Sb.prototype.render,render:function(a){this._UIBase_render(a);this.getDom("label").innerHTML="0"+this.editor.getLang("t_row")+" x 0"+this.editor.getLang("t_col")},_track:function(a,b){var c=this.getDom("overlay").style,d=this.lengthOfCellSide;c.width=a*d+"px";c.height=b*d+"px";this.getDom("label").innerHTML=a+this.editor.getLang("t_col")+" x "+b+this.editor.getLang("t_row");this.numCols=a;this.numRows=b},_onMouseOver:function(a,b){var c=a.relatedTarget||a.fromElement;!Ra.contains(b,
c)&&b!==c&&(this.getDom("label").innerHTML="0"+this.editor.getLang("t_col")+" x 0"+this.editor.getLang("t_row"),this.getDom("overlay").style.visibility="")},_onMouseOut:function(a,b){var c=a.relatedTarget||a.toElement;!Ra.contains(b,c)&&b!==c&&(this.getDom("label").innerHTML="0"+this.editor.getLang("t_col")+" x 0"+this.editor.getLang("t_row"),this.getDom("overlay").style.visibility="hidden")},_onMouseMove:function(a){this.getDom("overlay");var b=Ra.getEventOffset(a),c=this.lengthOfCellSide;a=Math.ceil(b.left/
c);b=Math.ceil(b.top/c);this._track(a,b)},_onClick:function(){this.fireEvent("picktable",this.numCols,this.numRows)}};Zc.inherits(Tb,Sb);var Ub=q.editor.dom.domUtils,Vb=q.editor.ui.uiUtils,$c='onmousedown="$$.Stateful_onMouseDown(event, this);" onmouseup="$$.Stateful_onMouseUp(event, this);"'+(q.editor.browser.ie?' onmouseenter="$$.Stateful_onMouseEnter(event, this);" onmouseleave="$$.Stateful_onMouseLeave(event, this);"':' onmouseover="$$.Stateful_onMouseOver(event, this);" onmouseout="$$.Stateful_onMouseOut(event, this);"');
...
this.removeState("active"),this.fireEvent("out")},Stateful_onMouseOver:function(a,b){var c=a.relatedTarget;!Vb.contains(b,c)&&b!==c&&this.Stateful_onMouseEnter(a,b)},Stateful_onMouseOut:function(a,b){var c=a.relatedTarget;!Vb.contains(b,c)&&b!==c&&this.Stateful_onMouseLeave(a,b)},Stateful_onMouseDown:function(){this.isDisabled()||this.addState("active")},Stateful_onMouseUp:function(){this.isDisabled()||this.removeState("active")},Stateful_postRender:function(){this.disabled&&!this.hasState("disabled")&&
this.addState("disabled")},hasState:function(a){return Ub.hasClass(this.getStateDom(),"edui-state-"+a)},addState:function(a){this.hasState(a)||(this.getStateDom().className+=" edui-state-"+a)},removeState:function(a){this.hasState(a)&&Ub.removeClasses(this.getStateDom(),["edui-state-"+a])},getStateDom:function(){return this.getDom("state")},isChecked:function(){return this.hasState("checked")},setChecked:function(a){!this.isDisabled()&&a?this.addState("checked"):this.removeState("checked")},isDisabled:function(){return this.hasState("disabled")},
setDisabled:function(a){a?(this.removeState("hover"),this.removeState("checked"),this.removeState("active"),this.addState("disabled")):this.removeState("disabled")}};var Wb=q.editor.utils,ad=q.editor.ui.UIBase,bd=q.editor.ui.Stateful,Sa=q.editor.ui.Button=function(a){this.initOptions(a);this.initButton()};Sa.prototype={uiName:"button",label:"",title:"",showIcon:!0,showText:!0,initButton:function(){this.initUIBase();this.Stateful_init()},getHtmlTpl:function(){return'<div id="##" class="edui-box %%"><div id="##_state" stateful><div class="%%-wrap"><div id="##_body" unselectable="on" '+
(this.title?'title="'+this.title+'"':"")+' class="%%-body" onmousedown="return false;" onclick="return $$._onClick();">'+(this.showIcon?'<div class="edui-box edui-icon"></div>':"")+(this.showText?'<div class="edui-box edui-label">'+this.label+"</div>":"")+"</div></div></div></div>"},postRender:function(){this.Stateful_postRender();this.setDisabled(this.disabled)},_onClick:function(){this.isDisabled()||this.fireEvent("click")}};Wb.inherits(Sa,ad);Wb.extend(Sa.prototype,bd);var ja=q.editor.utils,Ta=
q.editor.ui.uiUtils,Xb=q.editor.ui.UIBase,cd=q.editor.ui.Stateful,Ua=q.editor.ui.SplitButton=function(a){this.initOptions(a);this.initSplitButton()};Ua.prototype={popup:null,uiName:"splitbutton",title:"",initSplitButton:function(){this.initUIBase();this.Stateful_init();if(null!=this.popup){var a=this.popup;this.popup=null;this.setPopup(a)}},_UIBase_postRender:Xb.prototype.postRender,postRender:function(){this.Stateful_postRender();this._UIBase_postRender()},setPopup:function(a){this.popup!==a&&(null!=
this.popup&&this.popup.dispose(),a.addListener("show",ja.bind(this._onPopupShow,this)),a.addListener("hide",ja.bind(this._onPopupHide,this)),a.addListener("postrender",ja.bind(function(){a.getDom("body").appendChild(Ta.createElementByHtml('<div id="'+this.popup.id+'_bordereraser" class="edui-bordereraser edui-background" style="width:'+(Ta.getClientRect(this.getDom()).width-2)+'px"></div>'));a.getDom().className+=" "+this.className},this)),this.popup=a)},_onPopupShow:function(){this.addState("opened")},
_onPopupHide:function(){this.removeState("opened")},getHtmlTpl:function(){return'<div id="##" class="edui-box %%"><div '+(this.title?'title="'+this.title+'"':"")+' id="##_state" stateful><div class="%%-body"><div id="##_button_body" class="edui-box edui-button-body" onclick="$$._onButtonClick(event, this);"><div class="edui-box edui-icon"></div></div><div class="edui-box edui-splitborder"></div><div class="edui-box edui-arrow" onclick="$$._onArrowClick();"></div></div></div></div>'},showPopup:function(){var a=
Ta.getClientRect(this.getDom());a.top-=this.popup.SHADOW_RADIUS;a.height+=this.popup.SHADOW_RADIUS;this.popup.showAnchorRect(a)},_onArrowClick:function(){this.isDisabled()||this.showPopup()},_onButtonClick:function(){this.isDisabled()||this.fireEvent("buttonclick")}};ja.inherits(Ua,Xb);ja.extend(Ua.prototype,cd,!0);var dd=q.editor.utils,ed=q.editor.ui.uiUtils,fd=q.editor.ui.ColorPicker,gd=q.editor.ui.Popup,Yb=q.editor.ui.SplitButton,Zb=q.editor.ui.ColorButton=function(a){this.initOptions(a);this.initColorButton()};
Zb.prototype={initColorButton:function(){var a=this;this.popup=new gd({content:new fd({noColorText:a.editor.getLang("clearColor"),editor:a.editor,onpickcolor:function(b,c){a._onPickColor(c)},onpicknocolor:function(b,c){a._onPickNoColor(c)}}),editor:a.editor});this.initSplitButton()},_SplitButton_postRender:Yb.prototype.postRender,postRender:function(){this._SplitButton_postRender();this.getDom("button_body").appendChild(ed.createElementByHtml('<div id="'+this.id+'_colorlump" class="edui-colorlump"></div>'));
this.getDom().className+=" edui-colorbutton"},setColor:function(a){this.color=this.getDom("colorlump").style.backgroundColor=a},_onPickColor:function(a){!1!==this.fireEvent("pickcolor",a)&&(this.setColor(a),this.popup.hide())},_onPickNoColor:function(){!1!==this.fireEvent("picknocolor")&&this.popup.hide()}};dd.inherits(Zb,Yb);var hd=q.editor.utils,id=q.editor.ui.Popup,jd=q.editor.ui.TablePicker,kd=q.editor.ui.SplitButton,$b=q.editor.ui.TableButton=function(a){this.initOptions(a);this.initTableButton()};
$b.prototype={initTableButton:function(){var a=this;this.popup=new id({content:new jd({editor:a.editor,onpicktable:function(b,c,d){a._onPickTable(c,d)}}),editor:a.editor});this.initSplitButton()},_onPickTable:function(a,b){!1!==this.fireEvent("picktable",a,b)&&this.popup.hide()}};hd.inherits($b,kd);var ld=q.editor.utils,ac=q.editor.ui.UIBase,bc=q.editor.ui.AutoTypeSetPicker=function(a){this.initOptions(a);this.initAutoTypeSetPicker()};bc.prototype={initAutoTypeSetPicker:function(){this.initUIBase()},
...
_UIBase_render:ac.prototype.render};ld.inherits(bc,ac);var cc=function(a){for(var b=a.editor.options.autotypeset,c=a.getDom(),d=a.editor.uid,e=null,e=null,g=f.getElementsByTagName(c,"input"),h=g.length-1,j;j=g[h--];)if(e=j.getAttribute("type"),"checkbox"==e&&(e=j.getAttribute("name"),b[e]&&delete b[e],j.checked))if(j=document.getElementById(e+"Value"+d))if(/input/ig.test(j.tagName))b[e]=j.value;else{j=j.getElementsByTagName("input");for(var l=j.length-1,k;k=j[l--];)if(k.checked){b[e]=k.value;break}}else b[e]=
!0;c=f.getElementsByTagName(c,"select");for(h=0;d=c[h++];)g=d.getAttribute("name"),b[g]=b[g]?d.value:"";a.editor.options.autotypeset=b},md=q.editor.utils,nd=q.editor.ui.Popup,od=q.editor.ui.AutoTypeSetPicker,pd=q.editor.ui.SplitButton,dc=q.editor.ui.AutoTypeSetButton=function(a){this.initOptions(a);this.initAutoTypeSetButton()};dc.prototype={initAutoTypeSetButton:function(){var a=this;this.popup=new nd({content:new od({editor:a.editor}),editor:a.editor,hide:function(){!this._hidden&&this.getDom()&&
(cc(this),this.getDom().style.display="none",this._hidden=!0,this.fireEvent("hide"))}});var b=0;this.popup.addListener("postRenderAfter",function(){var c=this;b||(this.getDom().getElementsByTagName("button")[0].onclick=function(){cc(c);a.editor.execCommand("autotypeset");c.hide()},b=1)});this.initSplitButton()}};md.inherits(dc,pd);var ec=q.editor.utils,qd=q.editor.ui.Popup,rd=q.editor.ui.Stateful,fc=q.editor.ui.UIBase,Va=q.editor.ui.CellAlignPicker=function(a){this.initOptions(a);this.initSelected();
this.initCellAlignPicker()};Va.prototype={initSelected:function(){var a={top:0,middle:1,bottom:2},b={left:0,center:1,right:2};this.selected&&(this.selectedIndex=3*a[this.selected.valign]+b[this.selected.align])},initCellAlignPicker:function(){this.initUIBase();this.Stateful_init()},getHtmlTpl:function(){for(var a=["left","center","right"],b=null,c=-1,d=[],e=0;9>e;e++)b=this.selectedIndex===e?' class="edui-cellalign-selected" ':"",c=e%3,0===c&&d.push("<tr>"),d.push('<td index="'+e+'" '+b+' stateful><div class="edui-icon edui-'+
a[c]+'"></div></td>'),2===c&&d.push("</tr>");return'<div id="##" class="edui-cellalignpicker %%"><div class="edui-cellalignpicker-body"><table onclick="$$._onClick(event);">'+d.join("")+"</table></div></div>"},getStateDom:function(){return this.target},_onClick:function(a){var b=a.target||a.srcElement;/icon/.test(b.className)&&(this.items[b.parentNode.getAttribute("index")].onclick(),qd.postHide(a))},_UIBase_render:fc.prototype.render};ec.inherits(Va,fc);ec.extend(Va.prototype,rd,!0);var gc=q.editor.utils,
sd=q.editor.ui.Stateful,hc=q.editor.ui.uiUtils,ic=q.editor.ui.UIBase,Wa=q.editor.ui.PastePicker=function(a){this.initOptions(a);this.initPastePicker()};Wa.prototype={initPastePicker:function(){this.initUIBase();this.Stateful_init()},getHtmlTpl:function(){return'<div class="edui-pasteicon" onclick="$$._onClick(this)"></div><div class="edui-pastecontainer"><div class="edui-title">'+this.editor.getLang("pasteOpt")+'</div><div class="edui-button"><div title="'+this.editor.getLang("pasteSourceFormat")+
...
f.getNextDomNode(a),c=hc.getViewportRect().height,d=hc.getClientRect(b);b.style.top=d.top+d.height>c?-d.height-a.offsetHeight+"px":"";/hidden/ig.test(f.getComputedStyle(b,"visibility"))?(b.style.visibility="visible",f.addClass(a,"edui-state-opened")):(b.style.visibility="hidden",f.removeClasses(a,"edui-state-opened"))},_UIBase_render:ic.prototype.render};gc.inherits(Wa,ic);gc.extend(Wa.prototype,sd,!0);var td=q.editor.utils,ud=q.editor.ui.uiUtils,vd=q.editor.ui.UIBase,jc=q.editor.ui.Toolbar=function(a){this.initOptions(a);
this.initToolbar()};jc.prototype={items:null,initToolbar:function(){this.items=this.items||[];this.initUIBase()},add:function(a){this.items.push(a)},getHtmlTpl:function(){for(var a=[],b=0;b<this.items.length;b++)a[b]=this.items[b].renderHtml();return'<div id="##" class="edui-toolbar %%" onselectstart="return false;" onmousedown="return $$._onMouseDown(event, this);">'+a.join("")+"</div>"},postRender:function(){for(var a=this.getDom(),b=0;b<this.items.length;b++)this.items[b].postRender();ud.makeUnselectable(a)},
_onMouseDown:function(){return!1}};td.inherits(jc,vd);var Xa=q.editor.utils,wa=q.editor.dom.domUtils,ka=q.editor.ui.uiUtils,wd=q.editor.ui.UIBase,la=q.editor.ui.Popup,xd=q.editor.ui.Stateful,yd=q.editor.ui.CellAlignPicker,xa=q.editor.ui.Menu=function(a){this.initOptions(a);this.initMenu()},zd={renderHtml:function(){return'<div class="edui-menuitem edui-menuseparator"><div class="edui-menuseparator-inner"></div></div>'},postRender:function(){},queryAutoHide:function(){return!0}};xa.prototype={items:null,
uiName:"menu",initMenu:function(){this.items=this.items||[];this.initPopup();this.initItems()},initItems:function(){for(var a=0;a<this.items.length;a++){var b=this.items[a];"-"==b?this.items[a]=this.getSeparator():b instanceof ma||(b.editor=this.editor,b.theme=this.editor.options.theme,this.items[a]=this.createItem(b))}},getSeparator:function(){return zd},createItem:function(a){a.menu=this;return new ma(a)},_Popup_getContentHtmlTpl:la.prototype.getContentHtmlTpl,getContentHtmlTpl:function(){if(0==
this.items.length)return this._Popup_getContentHtmlTpl();for(var a=[],b=0;b<this.items.length;b++)a[b]=this.items[b].renderHtml();return'<div class="%%-body">'+a.join("")+"</div>"},_Popup_postRender:la.prototype.postRender,postRender:function(){for(var a=this,b=0;b<this.items.length;b++){var c=this.items[b];c.ownerMenu=this;c.postRender()}wa.on(this.getDom(),"mouseover",function(b){b=b||event;b=b.relatedTarget||b.fromElement;var c=a.getDom();!ka.contains(c,b)&&c!==b&&a.fireEvent("over")});this._Popup_postRender()},
queryAutoHide:function(a){if(a){if(ka.contains(this.getDom(),a))return!1;for(var b=0;b<this.items.length;b++)if(!1===this.items[b].queryAutoHide(a))return!1}},clearItems:function(){for(var a=0;a<this.items.length;a++){var b=this.items[a];clearTimeout(b._showingTimer);clearTimeout(b._closingTimer);b.subMenu&&b.subMenu.destroy()}this.items=[]},destroy:function(){this.getDom()&&wa.remove(this.getDom());this.clearItems()},dispose:function(){this.destroy()}};Xa.inherits(xa,la);var ma=q.editor.ui.MenuItem=
function(a){this.initOptions(a);this.initUIBase();this.Stateful_init();if(this.subMenu&&!(this.subMenu instanceof xa))if(a.className&&-1!=a.className.indexOf("aligntd")){var b=this;this.subMenu.selected=this.editor.queryCommandValue("cellalignment");this.subMenu=new la({content:new yd(this.subMenu),parentMenu:b,editor:b.editor,destroy:function(){this.getDom()&&wa.remove(this.getDom())}});this.subMenu.addListener("postRenderAfter",function(){wa.on(this.getDom(),"mouseover",function(){b.addState("opened")})})}else this.subMenu=
new xa(this.subMenu)};ma.prototype={label:"",subMenu:null,ownerMenu:null,uiName:"menuitem",alwalysHoverable:!0,getHtmlTpl:function(){return'<div id="##" class="%%" stateful onclick="$$._onClick(event, this);"><div class="%%-body">'+this.renderLabelHtml()+"</div></div>"},postRender:function(){var a=this;this.addListener("over",function(){a.ownerMenu.fireEvent("submenuover",a);a.subMenu&&a.delayShowSubMenu()});this.subMenu&&(this.getDom().className+=" edui-hassubmenu",this.subMenu.render(),this.addListener("out",
...
Xa.inherits(ma,wd);Xa.extend(ma.prototype,xd,!0);var Ad=q.editor.utils,Bd=q.editor.ui.uiUtils,Cd=q.editor.ui.Menu,kc=q.editor.ui.SplitButton,lc=q.editor.ui.Combox=function(a){this.initOptions(a);this.initCombox()};lc.prototype={uiName:"combox",initCombox:function(){var a=this;this.items=this.items||[];for(var b=0;b<this.items.length;b++){var c=this.items[b];c.uiName="listitem";c.index=b;c.onclick=function(){a.selectByIndex(this.index)}}this.popup=new Cd({items:this.items,uiName:"list",editor:this.editor});
this.initSplitButton()},_SplitButton_postRender:kc.prototype.postRender,postRender:function(){this._SplitButton_postRender();this.setLabel(this.label||"");this.setValue(this.initValue||"")},showPopup:function(){var a=Bd.getClientRect(this.getDom());a.top+=1;a.bottom-=1;a.height-=2;this.popup.showAnchorRect(a)},getValue:function(){return this.value},setValue:function(a){var b=this.indexByValue(a);-1!=b?(this.selectedIndex=b,this.setLabel(this.items[b].label),this.value=this.items[b].value):(this.selectedIndex=
-1,this.setLabel(this.getLabelForUnknowValue(a)),this.value=a)},setLabel:function(a){this.label=this.getDom("button_body").innerHTML=a},getLabelForUnknowValue:function(a){return a},indexByValue:function(a){for(var b=0;b<this.items.length;b++)if(a==this.items[b].value)return b;return-1},getItem:function(a){return this.items[a]},selectByIndex:function(a){a<this.items.length&&!1!==this.fireEvent("select",a)&&(this.selectedIndex=a,this.value=this.items[a].value,this.setLabel(this.items[a].label))}};Ad.inherits(lc,
kc);var mc=q.editor.utils,S=q.editor.dom.domUtils,T=q.editor.ui.uiUtils,nc=q.editor.ui.Mask,Dd=q.editor.ui.UIBase,Ya=q.editor.ui.Button,oc=q.editor.ui.Dialog=function(a){this.initOptions(mc.extend({autoReset:!0,draggable:!0,onok:function(){},oncancel:function(){},onclose:function(a,c){return c?this.onok():this.oncancel()},holdScroll:!1},a));this.initDialog()},pc,qc;oc.prototype={draggable:!1,uiName:"dialog",initDialog:function(){var a=this,b=this.editor.options.theme;this.initUIBase();this.modalMask=
pc||(pc=new nc({className:"edui-dialog-modalmask",theme:b}));this.dragMask=qc||(qc=new nc({className:"edui-dialog-dragmask",theme:b}));this.closeButton=new Ya({className:"edui-dialog-closebutton",title:a.closeDialog,theme:b,onclick:function(){a.close(!1)}});if(this.buttons)for(b=0;b<this.buttons.length;b++)this.buttons[b]instanceof Ya||(this.buttons[b]=new Ya(this.buttons[b]))},fitSize:function(){var a=this.getDom("body"),b=this.mesureSize();a.style.width=b.width+"px";a.style.height=b.height+"px";
...
close:function(a){!1!==this.fireEvent("close",a)&&this._hide()}};mc.inherits(oc,Dd);var Ed=q.editor.utils,Fd=q.editor.ui.Menu,Gd=q.editor.ui.SplitButton,rc=q.editor.ui.MenuButton=function(a){this.initOptions(a);this.initMenuButton()};rc.prototype={initMenuButton:function(){var a=this;this.uiName="menubutton";this.popup=new Fd({items:a.items,className:a.className,editor:a.editor});this.popup.addListener("show",function(){for(var b=0;b<this.items.length;b++)this.items[b].removeState("checked"),this.items[b].value==
a._value&&(this.items[b].addState("checked"),this.value=a._value)});this.initSplitButton()},setValue:function(a){this._value=a}};Ed.inherits(rc,Gd);var ya=q.editor.utils,y=q.editor.ui,Hd=y.Dialog;y.buttons={};y.Dialog=function(a){var b=new Hd(a);b.addListener("hide",function(){if(b.editor){var a=b.editor;try{if(n.gecko){var d=a.window.scrollY,e=a.window.scrollX;a.body.focus();a.window.scrollTo(e,d)}else a.focus()}catch(f){}}});return b};for(var Za={anchor:"~/dialogs/anchor/anchor.asp",insertimage:"~/dialogs/image/image.asp",
link:"~/dialogs/link/link.asp",spechars:"~/dialogs/spechars/spechars.asp",searchreplace:"~/dialogs/searchreplace/searchreplace.asp",map:"~/dialogs/map/map.asp",gmap:"~/dialogs/gmap/gmap.asp",insertvideo:"~/dialogs/video/video.asp",help:"~/dialogs/help/help.asp",emotion:"~/dialogs/emotion/emotion.asp",wordimage:"~/dialogs/wordimage/wordimage.asp",attachment:"~/dialogs/attachment/attachment.asp",insertframe:"~/dialogs/insertframe/insertframe.asp",edittip:"~/dialogs/table/edittip.asp",edittable:"~/dialogs/table/edittable.asp",
edittd:"~/dialogs/table/edittd.asp",snapscreen:"~/dialogs/snapscreen/snapscreen.asp",scrawl:"~/dialogs/scrawl/scrawl.asp",music:"~/dialogs/music/music.asp",template:"~/dialogs/template/template.asp"},Id="undo redo formatmatch bold italic underline fontborder touppercase tolowercase strikethrough subscript superscript source indent outdent blockquote pasteplain pagebreak selectall print preview horizontal removeformat time date unlink insertparagraphbeforetable insertrow insertcol mergeright mergedown deleterow deletecol splittorows splittocols splittocells mergecells deletetable".split(" "),
$a=0,W;W=Id[$a++];)W=W.toLowerCase(),y[W]=function(a){return function(b){var c=new y.Button({className:"edui-for-"+a,title:b.options.labelMap[a]||b.getLang("labelMap."+a)||"",onclick:function(){b.execCommand(a)},theme:b.options.theme,showText:!1});y.buttons[a]=c;b.addListener("selectionchange",function(d,e,f){d=b.queryCommandState(a);-1==d?(c.setDisabled(!0),c.setChecked(!1)):f||(c.setDisabled(!1),c.setChecked(d))});return c}}(W);y.cleardoc=function(a){var b=new y.Button({className:"edui-for-cleardoc",
title:a.options.labelMap.cleardoc||a.getLang("labelMap.cleardoc")||"",theme:a.options.theme,onclick:function(){confirm(a.getLang("confirmClear"))&&a.execCommand("cleardoc")}});y.buttons.cleardoc=b;a.addListener("selectionchange",function(){b.setDisabled(-1==a.queryCommandState("cleardoc"))});return b};var sc={justify:["left","right","center","justify"],imagefloat:["none","left","center","right"],directionality:["ltr","rtl"]},da;for(da in sc)(function(a,b){for(var c=0,d;d=b[c++];)(function(b){y[a.replace("float",
"")+b]=function(c){var d=new y.Button({className:"edui-for-"+a.replace("float","")+b,title:c.options.labelMap[a.replace("float","")+b]||c.getLang("labelMap."+a.replace("float","")+b)||"",theme:c.options.theme,onclick:function(){c.execCommand(a,b)}});y.buttons[a]=d;c.addListener("selectionchange",function(f,l,k){d.setDisabled(-1==c.queryCommandState(a));d.setChecked(c.queryCommandValue(a)==b&&!k)});return d}})(d)})(da,sc[da]);for($a=0;W=["backcolor","forecolor"][$a++];)y[W]=function(a){return function(b){var c=
new y.ColorButton({className:"edui-for-"+a,color:"default",title:b.options.labelMap[a]||b.getLang("labelMap."+a)||"",editor:b,onpickcolor:function(c,e){b.execCommand(a,e)},onpicknocolor:function(){b.execCommand(a,"default");this.setColor("transparent");this.color="default"},onbuttonclick:function(){b.execCommand(a,this.color)}});y.buttons[a]=c;b.addListener("selectionchange",function(){c.setDisabled(-1==b.queryCommandState(a))});return c}}(W);var tc={noOk:["searchreplace","help","spechars","webapp"],
ok:"attachment anchor link insertimage map gmap insertframe wordimage insertvideo insertframe edittip edittable edittd scrawl template music background".split(" ")};for(da in tc)(function(a,b){for(var c=0,d;d=b[c++];)n.opera&&"searchreplace"===d||function(b){y[b]=function(c,d,f){d=d||(c.options.iframeUrlMap||{})[b]||Za[b];f=c.options.labelMap[b]||c.getLang("labelMap."+b)||"";var l;d&&(l=new y.Dialog(ya.extend({iframeUrl:c.ui.mapUrl(d),editor:c,className:"edui-for-"+b,title:f,holdScroll:"insertimage"===
...
a.getLang("labelMap.fontfamily")||"";if(b.length){for(var d=0,e,f=[];e=b[d];d++){var h=a.getLang("fontfamily")[e.name]||"";(function(b,c){f.push({label:b,value:c,theme:a.options.theme,renderLabelHtml:function(){return'<div class="edui-label %%-label" style="font-family:'+ya.unhtml(this.value)+'">'+(this.label||"")+"</div>"}})})(e.label||h,e.val)}var j=new y.Combox({editor:a,items:f,onselect:function(b,c){a.execCommand("FontFamily",this.items[c].value)},onbuttonclick:function(){this.showPopup()},title:c,
...
b)}});y.buttons.lineheight=f;a.addListener("selectionchange",function(){var b=a.queryCommandState("LineHeight");if(-1==b)f.setDisabled(!0);else{f.setDisabled(!1);var c=a.queryCommandValue("LineHeight");c&&f.setValue((c+"").replace(/cm/,""));f.setChecked(b)}});return f}};for(var Jd=["top","bottom"],Kd=0,uc;uc=Jd[Kd++];)(function(a){y["rowspacing"+a]=function(b){var c=b.options["rowspacing"+a]||[];if(!c.length)return null;for(var d=0,e,f=[];e=c[d++];)f.push({label:e,value:e,theme:b.options.theme,onclick:function(){b.execCommand("rowspacing",
...
q.editor.dom.domUtils.remove(f);a&&window.scroll(0,0)},0)},0)}"true"===b.body.contentEditable&&(this.editor.fireEvent("fullscreenchanged",a),this.triggerLayout())}},_updateFullScreen:function(){if(this._fullscreen){var a=wc.getViewportRect();this.getDom().style.cssText="border:0;position:absolute;left:0;top:"+(this.editor.options.topOffset||0)+"px;width:"+a.width+"px;height:"+a.height+"px;z-index:"+(1*this.getDom().style.zIndex+100);wc.setViewportOffset(this.getDom(),{left:0,top:this.editor.options.topOffset||
...
b.langIsReady?e():b.addListener("langReady",e)})};return b};UE.getEditor=function(a,b){var c=na[a];c||(c=na[a]=new UE.ui.Editor(b),c.render(a));return c};UE.delEditor=function(a){var b;if(b=na[a])b.key&&b.destroy(),delete na[a]};var Od=q.editor.utils,Pd=q.editor.ui.Popup,Qd=q.editor.ui.SplitButton,yc=q.editor.ui.MultiMenuPop=function(a){this.initOptions(a);this.initMultiMenu()};yc.prototype={initMultiMenu:function(){var a=this;this.popup=new Pd({content:"",editor:a.editor,iframe_rendered:!1,onshow:function(){this.iframe_rendered||
(this.iframe_rendered=!0,this.getDom("content").innerHTML='<iframe id="'+a.id+'_iframe" src="'+a.iframeUrl+'" frameborder="0"></iframe>',a.editor.container.style.zIndex&&(this.getDom().style.zIndex=1*a.editor.container.style.zIndex+1))}});this.onbuttonclick=function(){this.showPopup()};this.initSplitButton()}};Od.inherits(yc,Qd)})();
