...
0:-1}};UE.commands.link={execCommand:function(b,c){var d;c._href&&(c._href=p.unhtml(c._href,/[<">]/g));c.href&&(c.href=p.unhtml(c.href,/[<">]/g));c.textValue&&(c.textValue=p.unhtml(c.textValue,/[<">]/g));var e=d=this.selection.getRange(),g=e.cloneRange(),h=this.queryCommandValue("link");a(e=e.adjustmentBoundary());var j=e.startContainer;if(1==j.nodeType&&h&&(j=j.childNodes[e.startOffset])&&1==j.nodeType&&"A"==j.tagName&&/^(?:https?|ftp|file)\s*:\s*\/\//.test(j[n.ie?"innerText":"textContent"]))j[n.ie?
"innerText":"textContent"]=p.html(c.textValue||c.href);if(!g.collapsed||h)e.removeInlineStyle("a"),g=e.cloneRange();if(g.collapsed){var h=e.document.createElement("a"),l="";c.textValue?(l=p.html(c.textValue),delete c.textValue):l=p.html(c.href);f.setAttributes(h,c);(j=f.findParentByTagName(g.startContainer,"a",!0))&&f.isInNodeEndBoundary(g,j)&&e.setStartAfter(j).collapse(!0);h[n.ie?"innerText":"textContent"]=l;e.insertNode(h).selectNode(h)}else e.applyInlineStyle("a",c);d.collapse().select(!0)},queryCommandValue:function(){var a=
...
e.start;(j=m.parentNode)&&!f.isBlockElm(j);)f.breakParent(m,j),f.clearEmptySibling(m);if(e.end){for(m=e.end;(j=m.parentNode)&&!f.isBlockElm(j);)f.breakParent(m,j),f.clearEmptySibling(m);for(j=f.getNextDomNode(e.start,!1,l);j&&j!=e.end;)m=f.getNextDomNode(j,!0,l),!t.$empty[j.tagName.toLowerCase()]&&!f.isBookmarkNode(j)&&(b.test(j.tagName)?c?(f.removeStyle(j,c),g(j)&&"text-decoration"!=c&&f.remove(j,!0)):f.remove(j,!0):!t.$tableContent[j.tagName]&&!t.$list[j.tagName]&&(f.removeAttributes(j,h),g(j)&&
...
a.endContainer;1==m.nodeType&&f.isEmptyNode(m)&&t.$removeEmpty[m.tagName];)c=m.parentNode,a.setEndBefore(m),f.remove(m),m=c;d.select()}}};UE.plugins.blockquote=function(){this.commands.blockquote={execCommand:function(a,b){var c=this.selection.getRange(),d=f.filterNodeList(this.selection.getStartElementPath(),"blockquote"),e=t.blockquote,g=c.createBookmark();if(d){var e=c.startContainer,e=f.isBlockElm(e)?e:f.findParent(e,function(a){return f.isBlockElm(a)}),h=c.endContainer,h=f.isBlockElm(h)?h:f.findParent(h,
function(a){return f.isBlockElm(a)}),e=f.findParentByTagName(e,"li",!0)||e,h=f.findParentByTagName(h,"li",!0)||h;"LI"==e.tagName||"TD"==e.tagName||e===d||f.isBody(e)?f.remove(d,!0):f.breakParent(e,d);e!==h&&(d=f.findParentByTagName(h,"blockquote"))&&("LI"==h.tagName||"TD"==h.tagName||f.isBody(h)?d.parentNode&&f.remove(d,!0):f.breakParent(h,d));for(var j=f.getElementsByTagName(this.document,"blockquote"),d=0,l;l=j[d++];)l.childNodes.length?f.getPosition(l,e)&f.POSITION_FOLLOWING&&f.getPosition(l,h)&
f.POSITION_PRECEDING&&f.remove(l,!0):f.remove(l)}else{d=c.cloneRange();j=h=1==d.startContainer.nodeType?d.startContainer:d.startContainer.parentNode;for(l=1;;){if(f.isBody(h)){j!==h?c.collapsed?(d.selectNode(j),l=0):d.setStartBefore(j):d.setStart(h,0);break}if(!e[h.tagName]){c.collapsed?d.selectNode(j):d.setStartBefore(j);break}j=h;h=h.parentNode}if(l)for(j=h=h=1==d.endContainer.nodeType?d.endContainer:d.endContainer.parentNode;;){if(f.isBody(h)){j!==h?d.setEndAfter(j):d.setEnd(h,h.childNodes.length);
break}if(!e[h.tagName]){d.setEndAfter(j);break}j=h;h=h.parentNode}h=c.document.createElement("blockquote");f.setAttributes(h,b);h.appendChild(d.extractContents());d.insertNode(h);e=f.getElementsByTagName(h,"blockquote");for(d=0;h=e[d++];)h.parentNode&&f.remove(h,!0)}c.moveToBookmark(g).select()},queryCommandState:function(){return f.filterNodeList(this.selection.getStartElementPath(),"blockquote")?1:0}}};UE.commands.indent={execCommand:function(){var a=this.queryCommandState("indent")?"0em":this.options.indentValue||
...
e),g&&("customstyle"==g&&e.style)&&(k.style.cssText=e.style));k.appendChild(q.extractContents());f.isEmptyNode(k)&&f.fillChar(c.document,k);q.insertNode(k);var E=k.parentNode;a(E)&&(!f.isBody(k.parentNode)&&-1==p.indexOf(b,E.tagName))&&(g&&"customstyle"==g||(E.getAttribute("dir")&&k.setAttribute("dir",E.getAttribute("dir")),E.style.cssText&&(k.style.cssText=E.style.cssText+";"+k.style.cssText),E.style.textAlign&&!k.style.textAlign&&(k.style.textAlign=E.style.textAlign),E.style.textIndent&&!k.style.textIndent&&
(k.style.textIndent=E.style.textIndent),E.style.padding&&!k.style.padding&&(k.style.padding=E.style.padding)),e&&/h\d/i.test(E.tagName)&&!/h\d/i.test(k.tagName)?(f.setAttributes(E,e),g&&("customstyle"==g&&e.style)&&(E.style.cssText=e.style),f.remove(k,!0),k=E):f.remove(k.parentNode,!0));k=-1!=p.indexOf(b,E.tagName)?E:k;k=f.getNextDomNode(k,!1,l)}else k=f.getNextDomNode(k,!0,l);c=c.moveToBookmark(m).moveToBookmark(j);h&&(c.setStartBefore(h).collapse(!0),pN=h.parentNode,f.remove(h),f.isBlockElm(pN)&&
f.isEmptyNode(pN)&&f.fillNode(this.document,pN));n.gecko&&c.collapsed&&1==c.startContainer.nodeType&&(e=c.startContainer.childNodes[c.startOffset])&&(1==e.nodeType&&e.tagName.toLowerCase()==d)&&c.setStart(e,0).collapse(!0);c.select();return!0},queryCommandValue:function(){var a=f.filterNodeList(this.selection.getStartElementPath(),"p h1 h2 h3 h4 h5 h6");return a?a.tagName.toLowerCase():""}}};UE.plugins.horizontal=function(){this.commands.horizontal={execCommand:function(a){if(-1!==this.queryCommandState(a)){this.execCommand("insertHtml",
"<hr>");a=this.selection.getRange();var b=a.startContainer;if(1==b.nodeType&&!b.childNodes[a.startOffset]){var c;if((c=b.childNodes[a.startOffset-1])&&1==c.nodeType&&"HR"==c.tagName)"p"==this.options.enterTag?(c=this.document.createElement("p"),a.insertNode(c),a.setStart(c,0).setCursor()):(c=this.document.createElement("br"),a.insertNode(c),a.setStartBefore(c).setCursor())}return!0}},queryCommandState:function(){return f.filterNodeList(this.selection.getStartElementPath(),"table")?-1:0}};this.addListener("delkeyup",
function(){var a=this.selection.getRange();f.isBody(a.startContainer)&&(a=a.startContainer.childNodes[a.startOffset-1])&&"HR"==a.nodeName&&f.remove(a)})};UE.commands.time=UE.commands.date={execCommand:function(a){var b=new Date;this.execCommand("insertHtml","time"==a?b.getHours()+":"+(10>b.getMinutes()?"0"+b.getMinutes():b.getMinutes())+":"+(10>b.getSeconds()?"0"+b.getSeconds():b.getSeconds()):b.getFullYear()+"-"+(10>b.getMonth()+1?"0"+(b.getMonth()+1):b.getMonth()+1)+"-"+(10>b.getDate()?"0"+b.getDate():
b.getDate()))}};UE.plugins.rowspacing=function(){this.setOpt({rowspacingtop:["5","10","15","20","25"],rowspacingbottom:["5","10","15","20","25"]});this.commands.rowspacing={execCommand:function(a,b,c){this.execCommand("paragraph","p",{style:"margin-"+c+":"+b+"px"});return!0},queryCommandValue:function(a,b){var c=f.filterNodeList(this.selection.getStartElementPath(),function(a){return f.isBlockElm(a)});return c?(c=f.getComputedStyle(c,"margin-"+b).replace(/[^\d]/g,""),!c?0:c):0}}};UE.plugins.lineheight=
function(){this.setOpt({lineheight:"1 1.5 1.75 2 3 4 5".split(" ")});this.commands.lineheight={execCommand:function(a,b){this.execCommand("paragraph","p",{style:"line-height:"+("1"==b?"normal":b+"em")});return!0},queryCommandValue:function(){var a=f.filterNodeList(this.selection.getStartElementPath(),function(a){return f.isBlockElm(a)});if(a)return a=f.getComputedStyle(a,"line-height"),"normal"==a?1:a.replace(/[^\d.]*/ig,"")}}};UE.plugins.insertcode=function(){var a=this;a.ready(function(){p.cssRule("pre",
"pre{margin:.5em 0;padding:.4em .6em;border-radius:8px;background:#f8f8f8;line-height:1.5}",a.document)});a.setOpt("insertcode",{as3:"ActionScript3",bash:"Bash/Shell",cpp:"C/C++",css:"Css",cf:"CodeFunction","c#":"C#",delphi:"Delphi",diff:"Diff",erlang:"Erlang",groovy:"Groovy",html:"Html",java:"Java",jfx:"JavaFx",js:"Javascript",pl:"Perl",php:"Php",plain:"Plain Text",ps:"PowerShell",python:"Python",ruby:"Ruby",scala:"Scala",sql:"Sql",vb:"Vb",xml:"Xml"});a.commands.insertcode={execCommand:function(a,
c){var d=this.selection.getRange(),e=f.findParentByTagName(d.startContainer,"pre",!0);if(e)e.className="brush:"+c+";toolbar:false;";else{var g="";d.collapsed?g=n.ie?8<n.version?"":"&nbsp;":"<br/>":(e=d.extractContents(),d=this.document.createElement("div"),d.appendChild(e),p.each(UE.filterNode(UE.htmlparser(d.innerHTML.replace(/[\r\t]/g,"")),this.options.filterTxtRules).children,function(a){n.ie&&8<n.version?("element"==a.type?"br"==a.tagName?g+="\n":t.$empty[a.tagName]||(p.each(a.children,function(b){"element"==
b.type?"br"==b.tagName?g+="\n":t.$empty[a.tagName]||(g+=b.innerText()):g+=b.data}),/\n$/.test(g)||(g+="\n")):g+=a.data+"\n",!a.nextSibling()&&/\n$/.test(g)&&(g=g.replace(/\n$/,""))):n.ie?("element"==a.type?"br"==a.tagName?g+="<br>":t.$empty[a.tagName]||(p.each(a.children,function(b){"element"==b.type?"br"==b.tagName?g+="<br>":t.$empty[a.tagName]||(g+=b.innerText()):g+=b.data}),/br>$/.test(g)||(g+="<br>")):g+=a.data+"<br>",!a.nextSibling()&&/<br>$/.test(g)&&(g=g.replace(/<br>$/,""))):(g+="element"==
a.type?t.$empty[a.tagName]?"":a.innerText():a.data,!/br\/?\s*>$/.test(g)&&a.nextSibling()&&(g+="<br>"))}));this.execCommand("inserthtml",'<pre id="coder"class="brush:'+c+';toolbar:false">'+g+"</pre>",!0);e=this.document.getElementById("coder");f.removeAttributes(e,"id");(d=e.previousSibling)&&f.isEmptyBlock(d)&&f.remove(d);d=this.selection.getRange();f.isEmptyBlock(e)?d.setStart(e,0).setCursor(!1,!0):d.selectNodeContents(e).select()}},queryCommandValue:function(){var a=this.selection.getStartElementPath(),
