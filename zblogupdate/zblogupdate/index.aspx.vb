    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.RawUrl.Contains("?install") = True Then
            ...
            If Application("Release") = Nothing Then
                s = My.Computer.FileSystem.ReadAllText(System.Web.HttpContext.Current.Request.PhysicalApplicationPath & "zblog2\" & "Release.xml")
        ...
        ElseIf Request.QueryString.Count > 0 Then
            ...
            Dim s As String = System.Web.HttpContext.Current.Request.PhysicalApplicationPath & "zblog2\" & Request.QueryString.Get(0)
